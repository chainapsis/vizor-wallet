//! USB transport and PCZT signing for the Ledger Zcash app.
//!
//! Every operation opens a fresh HID session so app transitions and approvals
//! cannot leak stale device state into the next operation.
