...
#[test]
fn unbroadcast_recovery_relay_attempt_waits_until_transaction_expiry() {
    for attempt_state in [
        ...
        let policy = migration::MigrationSubmissionPolicy::SeparateRelay(
        ...
        assert_eq!(
            ...
            .unwrap_err(),
            format!(
                "Migration recovery must wait until relay-attempted transaction {} expires at block 200",
                scheduled.txid_hex
            )
        );
