...
//! input lock until completion. Protocol roles and caller ownership:
//! `docs/contracts/references/signing/pczt-finalization.md` and
//! `docs/contracts/references/transactions/proposal-ownership.md`.
