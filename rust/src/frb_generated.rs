...
fn wire__crate__api__sync__create_or_resume_custom_migration_draft_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            let api_approved_schedule =
                <Vec<crate::api::sync::MigrationScheduledTransfer>>::sse_decode(&mut deserializer);
            let api_amount_group_count = <u32>::sse_decode(&mut deserializer);
            let api_parallel_schedule_count = <u32>::sse_decode(&mut deserializer);
            ...
            move |context| {
                transform_result_sse::<_, String>((move || {
                    let output_ok = crate::api::sync::create_or_resume_custom_migration_draft(
                        ...
                        api_approved_schedule,
                        api_amount_group_count,
                        api_parallel_schedule_count,
                        api_plan_seed,
...
impl SseDecode for crate::api::sync::OrchardMigrationPrivatePlan {
    ...
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        ...
        let mut var_customAmountGroupCount = <Option<u32>>::sse_decode(deserializer);
        let mut var_customParallelScheduleCount = <Option<u32>>::sse_decode(deserializer);
        ...
        return crate::api::sync::OrchardMigrationPrivatePlan {
            ...
            custom_amount_group_count: var_customAmountGroupCount,
            custom_parallel_schedule_count: var_customParallelScheduleCount,
...
impl flutter_rust_bridge::IntoDart for crate::api::sync::OrchardMigrationPrivatePlan {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        [
            ...
            self.custom_amount_group_count.into_into_dart().into_dart(),
            self.custom_parallel_schedule_count
                .into_into_dart()
                .into_dart(),
...
impl SseEncode for crate::api::sync::OrchardMigrationPrivatePlan {
    ...
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        ...
        <Option<u32>>::sse_encode(self.custom_amount_group_count, serializer);
        <Option<u32>>::sse_encode(self.custom_parallel_schedule_count, serializer);
