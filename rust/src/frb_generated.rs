...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -2000512975;
...
66 => wire__crate__api__wallet__generate_software_account_impl(port, ptr, rust_vec_len, data_len),
...
119 => wire__crate__api__voting__mark_vote_submitted_impl(port, ptr, rust_vec_len, data_len),
120 => wire__crate__api__sync__migrate_orchard_to_ironwood_impl(port, ptr, rust_vec_len, data_len),
121 => wire__crate__api__sync__migrate_orchard_to_ironwood_immediately_impl(port, ptr, rust_vec_len, data_len),
122 => wire__crate__api__sync__migrate_orchard_to_ironwood_with_macos_stored_mnemonic_impl(port, ptr, rust_vec_len, data_len),
124 => wire__crate__api__voting__next_share_tracking_delay_seconds_impl(port, ptr, rust_vec_len, data_len),
125 => wire__crate__api__keystone__pczt_spend_nullifiers_impl(port, ptr, rust_vec_len, data_len),
126 => wire__crate__api__voting__precompute_delegation_pir_impl(port, ptr, rust_vec_len, data_len),
127 => wire__crate__api__voting__precompute_snapshot_bundles_impl(port, ptr, rust_vec_len, data_len),
128 => wire__crate__api__voting__preflight_voting_helpers_impl(port, ptr, rust_vec_len, data_len),
129 => wire__crate__api__voting__prepare_committed_share_delivery_impl(port, ptr, rust_vec_len, data_len),
...
151 => wire__crate__api__sync__run_full_sync_blocking_impl(port, ptr, rust_vec_len, data_len),
152 => wire__crate__api__sync__scan_blocks_impl(port, ptr, rust_vec_len, data_len),
155 => wire__crate__api__voting__set_ballot_intent_impl(port, ptr, rust_vec_len, data_len),
158 => wire__crate__api__sync__set_transaction_status_impl(port, ptr, rust_vec_len, data_len),
159 => wire__crate__api__voting__setup_delegation_bundles_impl(port, ptr, rust_vec_len, data_len),
...
167 => wire__crate__api__sync__store_and_broadcast_pczts_with_keystone_signatures_for_proposal_impl(port, ptr, rust_vec_len, data_len),
...
171 => wire__crate__api__voting__submit_prepared_shares_to_helpers_impl(port, ptr, rust_vec_len, data_len),
...
179 => wire__crate__api__voting__track_pending_shares_impl(port, ptr, rust_vec_len, data_len),
...
184 => wire__crate__api__voting__vote_commitment_wire_json_impl(port, ptr, rust_vec_len, data_len),
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        88 => wire__crate__api__sync__get_pczt_expiry_height_impl(ptr, rust_vec_len, data_len),
        89 => wire__crate__api__sync__get_pczt_txid_impl(ptr, rust_vec_len, data_len),
        ...
        123 => wire__crate__api__wallet__mnemonic_word_list_impl(ptr, rust_vec_len, data_len),
        ...
        154 => wire__crate__api__sync__set_active_sync_account_impl(ptr, rust_vec_len, data_len),
