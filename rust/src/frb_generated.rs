...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -384600826;
...
fn wire__crate__api__pir__cancel_startup_pir_impl(
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
) -> flutter_rust_bridge::for_generated::WireSyncRust2DartSse {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            transform_result_sse::<_, ()>((move || {
                let output_ok = Result::<_, ()>::Ok({
                    crate::api::pir::cancel_startup_pir();
                })?;
                Ok(output_ok)
            })())
        },
...
fn wire__crate__api__pir__is_startup_pir_running_impl(
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
) -> flutter_rust_bridge::for_generated::WireSyncRust2DartSse {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "is_startup_pir_running",
            port: None,
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Sync,
        },
        move || {
            ...
            deserializer.end();
            transform_result_sse::<_, ()>((move || {
                let output_ok = Result::<_, ()>::Ok(crate::api::pir::is_startup_pir_running())?;
                Ok(output_ok)
            })())
        },
    )
...
fn wire__crate__api__pir__run_startup_pir_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            let api_db_path = <String>::sse_decode(&mut deserializer);
            let api_network = <String>::sse_decode(&mut deserializer);
            let api_spend_server_url_override = <Option<String>>::sse_decode(&mut deserializer);
            let api_witness_server_url_override = <Option<String>>::sse_decode(&mut deserializer);
            let api_sink = <StreamSink<
                crate::api::pir::ApiPirProgressEvent,
                flutter_rust_bridge::for_generated::SseCodec,
            >>::sse_decode(&mut deserializer);
            deserializer.end();
            move |context| {
                transform_result_sse::<_, String>((move || {
                    let output_ok = crate::api::pir::run_startup_pir(
                        api_db_path,
                        api_network,
                        api_spend_server_url_override,
                        api_witness_server_url_override,
                        api_sink,
                    )?;
                    Ok(output_ok)
                })())
...
impl SseDecode for crate::api::pir::ApiPirProgressEvent {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut var_phase = <String>::sse_decode(deserializer);
        let mut var_completed = <u32>::sse_decode(deserializer);
        let mut var_total = <u32>::sse_decode(deserializer);
        let mut var_witnessesInserted = <u32>::sse_decode(deserializer);
        let mut var_skippedReason = <Option<String>>::sse_decode(deserializer);
        return crate::api::pir::ApiPirProgressEvent {
            phase: var_phase,
            completed: var_completed,
            total: var_total,
            witnesses_inserted: var_witnessesInserted,
            skipped_reason: var_skippedReason,
        };
    }
}
...
27 => wire__crate__api__voting__delete_voting_account_state_impl(port, ptr, rust_vec_len, data_len),
28 => wire__crate__api__secret__derive_secret_password_verifier_impl(port, ptr, rust_vec_len, data_len),
...
103 => wire__crate__api__pir__run_startup_pir_impl(port, ptr, rust_vec_len, data_len),
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        9 => wire__crate__api__pir__cancel_startup_pir_impl(ptr, rust_vec_len, data_len),
        ...
        67 => wire__crate__api__pir__is_startup_pir_running_impl(ptr, rust_vec_len, data_len),
...
// Codec=Dco (DartCObject based), see doc to use other codecs
impl flutter_rust_bridge::IntoDart for crate::api::pir::ApiPirProgressEvent {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        [
            self.phase.into_into_dart().into_dart(),
            self.completed.into_into_dart().into_dart(),
            self.total.into_into_dart().into_dart(),
            self.witnesses_inserted.into_into_dart().into_dart(),
            self.skipped_reason.into_into_dart().into_dart(),
        ]
        .into_dart()
    }
}
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for crate::api::pir::ApiPirProgressEvent
{
}
impl flutter_rust_bridge::IntoIntoDart<crate::api::pir::ApiPirProgressEvent>
    for crate::api::pir::ApiPirProgressEvent
{
    fn into_into_dart(self) -> crate::api::pir::ApiPirProgressEvent {
        self
    }
}
// Codec=Dco (DartCObject based), see doc to use other codecs
...
impl SseEncode for crate::api::pir::ApiPirProgressEvent {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <String>::sse_encode(self.phase, serializer);
        <u32>::sse_encode(self.completed, serializer);
        <u32>::sse_encode(self.total, serializer);
        <u32>::sse_encode(self.witnesses_inserted, serializer);
        <Option<String>>::sse_encode(self.skipped_reason, serializer);
    }
}
