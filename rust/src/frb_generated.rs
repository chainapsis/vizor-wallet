...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1565781816;
...
fn wire__crate__api__voting__has_persisted_delegation_proof_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "has_persisted_delegation_proof",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            move |context| {
                transform_result_sse::<_, String>((move || {
                    let output_ok = crate::api::voting::has_persisted_delegation_proof(
                        api_db_path,
                        api_account_uuid,
                        api_round_id,
                        api_bundle_index,
...
100 => wire__crate__api__voting__has_persisted_delegation_proof_impl(port, ptr, rust_vec_len, data_len),
...
116 => wire__crate__api__voting__mark_delegation_submitted_impl(port, ptr, rust_vec_len, data_len),
117 => wire__crate__api__voting__mark_vote_submitted_impl(port, ptr, rust_vec_len, data_len),
