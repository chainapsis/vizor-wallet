...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -261264511;
...
129 => wire__crate__api__payment_uri__parse_cross_chain_payment_uri_impl(port, ptr, rust_vec_len, data_len),
