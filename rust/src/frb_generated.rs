...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 943548511;
...
63 => wire__crate__api__sync__estimate_send_max_impl(port, ptr, rust_vec_len, data_len),
64 => wire__crate__api__voting__evaluate_voting_participation_impl(port, ptr, rust_vec_len, data_len),
65 => wire__crate__api__wallet__evict_wallet_summary_cache_impl(port, ptr, rust_vec_len, data_len),
66 => wire__crate__api__sync__execute_proposal_impl(port, ptr, rust_vec_len, data_len),
67 => wire__crate__api__sync__execute_proposal_with_macos_stored_mnemonic_impl(port, ptr, rust_vec_len, data_len),
68 => wire__crate__api__sync__export_orchard_migration_outbox_impl(port, ptr, rust_vec_len, data_len),
69 => wire__crate__api__sync__extract_and_broadcast_pczt_impl(port, ptr, rust_vec_len, data_len),
72 => wire__crate__api__wallet__generate_software_account_impl(port, ptr, rust_vec_len, data_len),
...
82 => wire__crate__api__wallet__get_gift_address_variants_impl(port, ptr, rust_vec_len, data_len),
83 => wire__crate__api__network_privacy__get_import_birthday_metadata_impl(port, ptr, rust_vec_len, data_len),
84 => wire__crate__api__voting__get_keystone_signatures_impl(port, ptr, rust_vec_len, data_len),
85 => wire__crate__api__wallet__get_latest_block_height_impl(port, ptr, rust_vec_len, data_len),
86 => wire__crate__api__sync__get_ledger_shielding_progress_impl(port, ptr, rust_vec_len, data_len),
87 => wire__crate__api__wallet__get_lightwalletd_chain_name_impl(port, ptr, rust_vec_len, data_len),
89 => wire__crate__api__sync__get_next_available_address_impl(port, ptr, rust_vec_len, data_len),
90 => wire__crate__api__sync__get_next_subtree_indices_impl(port, ptr, rust_vec_len, data_len),
91 => wire__crate__api__sync__get_orchard_migration_immediate_plan_impl(port, ptr, rust_vec_len, data_len),
92 => wire__crate__api__sync__get_orchard_migration_private_plan_impl(port, ptr, rust_vec_len, data_len),
93 => wire__crate__api__sync__get_orchard_migration_status_impl(port, ptr, rust_vec_len, data_len),
94 => wire__crate__api__sync__get_orchard_migration_statuses_impl(port, ptr, rust_vec_len, data_len),
95 => wire__crate__api__sync__get_payment_link_spend_evidence_impl(port, ptr, rust_vec_len, data_len),
98 => wire__crate__api__sync__get_previous_transaction_count_for_address_impl(port, ptr, rust_vec_len, data_len),
99 => wire__crate__api__wallet__get_receive_address_aliases_impl(port, ptr, rust_vec_len, data_len),
100 => wire__crate__api__wallet__get_recent_transparent_receive_addresses_impl(port, ptr, rust_vec_len, data_len),
101 => wire__crate__api__voting__get_round_plan_impl(port, ptr, rust_vec_len, data_len),
102 => wire__crate__api__sync__get_shield_transparent_status_impl(port, ptr, rust_vec_len, data_len),
104 => wire__crate__api__sync__get_sync_status_impl(port, ptr, rust_vec_len, data_len),
105 => wire__crate__api__sync__get_transaction_data_requests_impl(port, ptr, rust_vec_len, data_len),
106 => wire__crate__api__sync__get_transaction_detail_impl(port, ptr, rust_vec_len, data_len),
107 => wire__crate__api__sync__get_transaction_history_impl(port, ptr, rust_vec_len, data_len),
108 => wire__crate__api__wallet__get_transparent_receive_address_impl(port, ptr, rust_vec_len, data_len),
109 => wire__crate__api__wallet__get_unified_address_impl(port, ptr, rust_vec_len, data_len),
113 => wire__crate__api__wallet__import_hardware_account_impl(port, ptr, rust_vec_len, data_len),
114 => wire__crate__api__wallet__import_software_account_at_index_impl(port, ptr, rust_vec_len, data_len),
115 => wire__crate__api__wallet__import_software_wallet_with_account_discovery_impl(port, ptr, rust_vec_len, data_len),
116 => wire__crate__api__wallet__import_wallet_impl(port, ptr, rust_vec_len, data_len),
117 => wire__crate__api__simple__init_app_impl(port, ptr, rust_vec_len, data_len),
118 => wire__crate__api__gift_card_tracking__inspect_gift_card_usage_impl(port, ptr, rust_vec_len, data_len),
121 => wire__crate__api__wallet__is_software_wallet_link_account_imported_impl(port, ptr, rust_vec_len, data_len),
125 => wire__crate__api__sync__keystone_migration_proof_status_impl(port, ptr, rust_vec_len, data_len),
127 => wire__crate__api__ledger__ledger_ack_signed_operation_impl(port, ptr, rust_vec_len, data_len),
128 => wire__crate__api__ledger__ledger_broadcast_signed_operation_impl(port, ptr, rust_vec_len, data_len),
129 => wire__crate__api__ledger__ledger_build_pczt_full_signing_apdu_plan_impl(port, ptr, rust_vec_len, data_len),
130 => wire__crate__api__ledger__ledger_build_pczt_signing_apdu_plan_impl(port, ptr, rust_vec_len, data_len),
131 => wire__crate__api__ledger__ledger_build_ufvk_apdu_plan_impl(port, ptr, rust_vec_len, data_len),
133 => wire__crate__api__ledger__ledger_checkpoint_signed_operation_impl(port, ptr, rust_vec_len, data_len),
134 => wire__crate__api__ledger__ledger_checkpoint_signed_operation_batch_impl(port, ptr, rust_vec_len, data_len),
135 => wire__crate__api__ledger__ledger_device_app_impl(port, ptr, rust_vec_len, data_len),
136 => wire__crate__api__ledger__ledger_export_account_impl(port, ptr, rust_vec_len, data_len),
137 => wire__crate__api__ledger__ledger_export_ufvk_impl(port, ptr, rust_vec_len, data_len),
138 => wire__crate__api__ledger__ledger_finalize_mobile_pczt_full_signing_impl(port, ptr, rust_vec_len, data_len),
139 => wire__crate__api__ledger__ledger_finalize_mobile_pczt_signing_impl(port, ptr, rust_vec_len, data_len),
140 => wire__crate__api__ledger__ledger_list_signed_operations_impl(port, ptr, rust_vec_len, data_len),
141 => wire__crate__api__ledger__ledger_open_zcash_app_impl(port, ptr, rust_vec_len, data_len),
142 => wire__crate__api__ledger__ledger_parse_mobile_ufvk_responses_impl(port, ptr, rust_vec_len, data_len),
143 => wire__crate__api__ledger__ledger_sign_pczt_impl(port, ptr, rust_vec_len, data_len),
144 => wire__crate__api__ledger__ledger_sign_pczt_full_impl(port, ptr, rust_vec_len, data_len),
145 => wire__crate__api__ledger__ledger_sign_with_progress_impl(port, ptr, rust_vec_len, data_len),
146 => wire__crate__api__ledger__ledger_validate_supported_pczt_impl(port, ptr, rust_vec_len, data_len),
147 => wire__crate__api__wallet__list_accounts_impl(port, ptr, rust_vec_len, data_len),
148 => wire__crate__api__gift_card_tracking__list_gift_card_observers_impl(port, ptr, rust_vec_len, data_len),
149 => wire__crate__api__voting__list_pending_share_rounds_impl(port, ptr, rust_vec_len, data_len),
150 => wire__crate__api__sync__migrate_orchard_to_ironwood_impl(port, ptr, rust_vec_len, data_len),
151 => wire__crate__api__sync__migrate_orchard_to_ironwood_immediately_impl(port, ptr, rust_vec_len, data_len),
152 => wire__crate__api__sync__migrate_orchard_to_ironwood_with_macos_stored_mnemonic_impl(port, ptr, rust_vec_len, data_len),
155 => wire__crate__api__keystone__pczt_spend_nullifiers_impl(port, ptr, rust_vec_len, data_len),
156 => wire__crate__api__voting__precompute_delegation_proof_impl(port, ptr, rust_vec_len, data_len),
157 => wire__crate__api__voting__precompute_snapshot_bundles_impl(port, ptr, rust_vec_len, data_len),
158 => wire__crate__api__sync__prepare_orchard_migration_batch_pczt_impl(port, ptr, rust_vec_len, data_len),
159 => wire__crate__api__sync__prepare_orchard_migration_denominations_pczt_impl(port, ptr, rust_vec_len, data_len),
160 => wire__crate__api__sync__prepare_orchard_migration_immediate_pczt_impl(port, ptr, rust_vec_len, data_len),
161 => wire__crate__api__sync__prepare_orchard_migration_outbox_impl(port, ptr, rust_vec_len, data_len),
162 => wire__crate__api__sync__prepare_orchard_migration_single_qr_pczt_impl(port, ptr, rust_vec_len, data_len),
163 => wire__crate__api__sync__prepare_pczt_for_keystone_batch_impl(port, ptr, rust_vec_len, data_len),
164 => wire__crate__api__voting__prepare_voting_participation_impl(port, ptr, rust_vec_len, data_len),
165 => wire__crate__api__wallet__preview_software_account_transparent_balance_impl(port, ptr, rust_vec_len, data_len),
166 => wire__crate__api__sync__propose_send_impl(port, ptr, rust_vec_len, data_len),
167 => wire__crate__api__sync__put_subtree_roots_impl(port, ptr, rust_vec_len, data_len),
168 => wire__crate__api__network_privacy__quiesce_network_privacy_direct_requests_impl(port, ptr, rust_vec_len, data_len),
169 => wire__crate__api__sync__reconcile_orchard_migration_outbox_receipt_impl(port, ptr, rust_vec_len, data_len),
170 => wire__crate__api__sync__redact_pczt_for_signer_impl(port, ptr, rust_vec_len, data_len),
171 => wire__crate__api__gift_card_tracking__register_gift_card_observer_impl(port, ptr, rust_vec_len, data_len),
172 => wire__crate__api__gift_card_tracking__remove_gift_card_observer_impl(port, ptr, rust_vec_len, data_len),
174 => wire__crate__api__voting__reset_vote_tree_impl(port, ptr, rust_vec_len, data_len),
175 => wire__crate__api__voting__reset_voting_session_state_impl(port, ptr, rust_vec_len, data_len),
176 => wire__crate__api__voting__resolve_pir_snapshot_endpoint_impl(port, ptr, rust_vec_len, data_len),
177 => wire__crate__api__voting__resolve_static_voting_config_impl(port, ptr, rust_vec_len, data_len),
178 => wire__crate__api__voting__resolve_voting_config_from_attempts_impl(port, ptr, rust_vec_len, data_len),
179 => wire__crate__api__sync__retain_proposal_lock_until_expiry_impl(port, ptr, rust_vec_len, data_len),
180 => wire__crate__api__sync__retire_unbroadcast_orchard_migration_impl(port, ptr, rust_vec_len, data_len),
181 => wire__crate__api__sync__rewind_to_height_impl(port, ptr, rust_vec_len, data_len),
182 => wire__zcash_voting__wire__round_work_tally_view_default_impl(port, ptr, rust_vec_len, data_len),
183 => wire__crate__api__sync__run_full_sync_blocking_impl(port, ptr, rust_vec_len, data_len),
184 => wire__crate__api__sync__run_payment_link_claim_sync_impl(port, ptr, rust_vec_len, data_len),
186 => wire__crate__api__sync__scan_blocks_impl(port, ptr, rust_vec_len, data_len),
190 => wire__crate__api__sync__set_transaction_status_impl(port, ptr, rust_vec_len, data_len),
191 => wire__crate__api__voting__set_voting_observability_sink_impl(port, ptr, rust_vec_len, data_len),
192 => wire__crate__api__voting__setup_delegation_bundles_impl(port, ptr, rust_vec_len, data_len),
193 => wire__zcash_voting__wire__share_tracking_pass_report_view_default_impl(port, ptr, rust_vec_len, data_len),
...
201 => wire__crate__api__network_privacy__stop_tor_update_relay_impl(port, ptr, rust_vec_len, data_len),
202 => wire__crate__api__sync__store_and_broadcast_pczts_with_keystone_signatures_for_proposal_impl(port, ptr, rust_vec_len, data_len),
203 => wire__crate__api__sync__store_and_broadcast_signed_pczts_for_proposal_impl(port, ptr, rust_vec_len, data_len),
204 => wire__crate__api__voting__store_keystone_signatures_batch_impl(port, ptr, rust_vec_len, data_len),
205 => wire__crate__api__sync__suggest_scan_ranges_impl(port, ptr, rust_vec_len, data_len),
206 => wire__crate__api__gift_card_tracking__sync_gift_card_observers_impl(port, ptr, rust_vec_len, data_len),
207 => wire__crate__api__voting__sync_vote_tree_impl(port, ptr, rust_vec_len, data_len),
210 => wire__crate__api__network_privacy__tor_http_download_impl(port, ptr, rust_vec_len, data_len),
211 => wire__crate__api__network_privacy__tor_http_get_impl(port, ptr, rust_vec_len, data_len),
212 => wire__crate__api__network_privacy__tor_http_post_impl(port, ptr, rust_vec_len, data_len),
213 => wire__crate__api__voting__trusted_voting_round_params_from_config_impl(port, ptr, rust_vec_len, data_len),
214 => wire__crate__api__sync__update_chain_tip_impl(port, ptr, rust_vec_len, data_len),
215 => wire__crate__api__sync__validate_address_impl(port, ptr, rust_vec_len, data_len),
216 => wire__crate__api__wallet__validate_gift_address_impl(port, ptr, rust_vec_len, data_len),
218 => wire__crate__api__voting__voting_proposal_id_range_impl(port, ptr, rust_vec_len, data_len),
221 => wire__crate__api__voting__warm_pir_proof_cache_impl(port, ptr, rust_vec_len, data_len),
223 => wire__crate__api__sync__write_block_metadata_impl(port, ptr, rust_vec_len, data_len),
224 => wire__crate__api__keystone__zcash_sign_batch_round_message_counts_impl(port, ptr, rust_vec_len, data_len),
                        _ => unreachable!(),
                    }
}
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        70 => wire__crate__api__network_privacy__fail_network_privacy_enable_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        ...
        88 => wire__crate__api__network_privacy__get_network_privacy_status_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        96 => wire__crate__api__sync__get_pczt_expiry_height_impl(ptr, rust_vec_len, data_len),
        97 => wire__crate__api__sync__get_pczt_txid_impl(ptr, rust_vec_len, data_len),
        103 => wire__crate__api__sync__get_sync_mode_impl(ptr, rust_vec_len, data_len),
        110 => {
            wire__crate__api__wallet__gift_mnemonic_from_entropy_impl(ptr, rust_vec_len, data_len)
        }
        111 => wire__crate__api__wallet__gift_mnemonic_to_entropy_impl(ptr, rust_vec_len, data_len),
        112 => wire__crate__api__simple__greet_impl(ptr, rust_vec_len, data_len),
        119 => wire__crate__api__voting__is_last_moment_impl(ptr, rust_vec_len, data_len),
        120 => {
            wire__crate__api__sync__is_mempool_observer_running_impl(ptr, rust_vec_len, data_len)
        }
        122 => wire__crate__api__sync__is_sync_cancel_requested_impl(ptr, rust_vec_len, data_len),
        123 => wire__crate__api__sync__is_sync_running_impl(ptr, rust_vec_len, data_len),
        124 => wire__crate__api__network_privacy__is_tor_enabled_impl(ptr, rust_vec_len, data_len),
        126 => {
            wire__crate__api__voting__last_moment_buffer_seconds_impl(ptr, rust_vec_len, data_len)
        }
        132 => wire__crate__api__ledger__ledger_cancel_operation_impl(ptr, rust_vec_len, data_len),
        153 => wire__crate__api__wallet__mnemonic_word_list_impl(ptr, rust_vec_len, data_len),
        154 => wire__crate__api__voting_session__open_voting_round_session_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        173 => wire__crate__api__keystone__reset_ur_session_impl(ptr, rust_vec_len, data_len),
        185 => wire__crate__api__wallet__same_orchard_receiver_impl(ptr, rust_vec_len, data_len),
        187 => wire__crate__api__sync__set_active_sync_account_impl(ptr, rust_vec_len, data_len),
        188 => wire__crate__api__network_privacy__set_network_privacy_dormant_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        189 => wire__crate__api__sync__set_sync_mode_impl(ptr, rust_vec_len, data_len),
        200 => wire__crate__api__sync__stop_mempool_observer_impl(ptr, rust_vec_len, data_len),
        208 => wire__crate__api__network_privacy__tor_http_begin_request_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        209 => wire__crate__api__network_privacy__tor_http_cancel_request_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        217 => wire__crate__api__wallet__validate_mnemonic_impl(ptr, rust_vec_len, data_len),
        219 => wire__crate__api__wallet__wallet_exists_impl(ptr, rust_vec_len, data_len),
        220 => {
