...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -109724356;
...
58 => wire__crate__api__multisig__get_multisig_session_roster_impl(port, ptr, rust_vec_len, data_len),
...
116 => wire__crate__api__multisig__restore_multisig_share_backup_impl(port, ptr, rust_vec_len, data_len),
