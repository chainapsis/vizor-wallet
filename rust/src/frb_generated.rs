...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1523254935;
...
fn wire__crate__api__sync__get_export_birthday_info_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "get_export_birthday_info",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            move |context| {
                transform_result_sse::<_, String>((move || {
                    let output_ok = crate::api::sync::get_export_birthday_info(
                        api_db_path,
                        api_network,
                        api_lightwalletd_url,
                        api_account_uuid,
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        23 => {
            wire__crate__api__sync__get_export_birthday_info_impl(port, ptr, rust_vec_len, data_len)
        }
        24 => wire__crate__api__wallet__get_latest_block_height_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        25 => wire__crate__api__wallet__get_lightwalletd_chain_name_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        26 => wire__crate__api__sync__get_next_available_address_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        28 => wire__crate__api__sync__get_shield_transparent_status_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        31 => wire__crate__api__sync__get_transaction_data_requests_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        34 => wire__crate__api__wallet__get_transparent_address_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        35 => wire__crate__api__wallet__get_unified_address_impl(port, ptr, rust_vec_len, data_len),
        37 => wire__crate__api__wallet__import_hardware_account_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        38 => wire__crate__api__wallet__import_wallet_impl(port, ptr, rust_vec_len, data_len),
        39 => wire__crate__api__simple__init_app_impl(port, ptr, rust_vec_len, data_len),
        40 => wire__crate__api__keystone__is_keystone_connected_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        44 => wire__crate__api__keystone__keystone_usb_sign_pczt_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        29 => wire__crate__api__sync__get_sync_mode_impl(ptr, rust_vec_len, data_len),
        32 => wire__crate__api__sync__get_transaction_detail_impl(ptr, rust_vec_len, data_len),
...
// Codec=Dco (DartCObject based), see doc to use other codecs
impl flutter_rust_bridge::IntoDart for crate::api::sync::ExportBirthdayInfo {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        [
...
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for crate::api::sync::ExportBirthdayInfo
{
}
impl flutter_rust_bridge::IntoIntoDart<crate::api::sync::ExportBirthdayInfo>
    for crate::api::sync::ExportBirthdayInfo
{
    fn into_into_dart(self) -> crate::api::sync::ExportBirthdayInfo {
        self
    }
}
// Codec=Dco (DartCObject based), see doc to use other codecs
...
impl SseEncode for crate::api::sync::ExportBirthdayInfo {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
