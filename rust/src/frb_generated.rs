...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1814546346;
...
fn wire__crate__api__wallet__is_address_from_account_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "is_address_from_account",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            move |context| {
                transform_result_sse::<_, String>((move || {
                    let output_ok = crate::api::wallet::is_address_from_account(
                        api_db_path,
                        api_network,
                        api_account_uuid,
                        api_address,
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        46 => wire__crate__api__wallet__is_address_from_account_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
