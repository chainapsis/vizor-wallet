...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1242470621;
...
fn wire__crate__api__voting__is_wallet_scanned_to_voting_snapshot_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "is_wallet_scanned_to_voting_snapshot",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            move |context| {
                transform_result_sse::<_, String>((move || {
                    let output_ok = crate::api::voting::is_wallet_scanned_to_voting_snapshot(
                        api_db_path,
                        api_network,
                        api_snapshot_height,
                    )?;
...
107 => wire__crate__api__voting__is_wallet_scanned_to_voting_snapshot_impl(port, ptr, rust_vec_len, data_len),
