...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1087623681;
...
fn wire__crate__api__sync__create_or_resume_custom_migration_draft_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "create_or_resume_custom_migration_draft",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            let api_network = <String>::sse_decode(&mut deserializer);
            let api_account_uuid = <String>::sse_decode(&mut deserializer);
            let api_target_values_zatoshi = <Vec<u64>>::sse_decode(&mut deserializer);
            let api_approved_schedule =
                <Vec<crate::api::sync::MigrationScheduledTransfer>>::sse_decode(&mut deserializer);
            let api_profile_count = <u32>::sse_decode(&mut deserializer);
            let api_concurrent_profiles = <u32>::sse_decode(&mut deserializer);
            let api_plan_seed = <u64>::sse_decode(&mut deserializer);
            let api_space_preparation_broadcasts = <bool>::sse_decode(&mut deserializer);
            deserializer.end();
            move |context| {
                transform_result_sse::<_, String>((move || {
                    let output_ok = crate::api::sync::create_or_resume_custom_migration_draft(
                        api_db_path,
                        api_network,
                        api_account_uuid,
                        api_target_values_zatoshi,
                        api_approved_schedule,
                        api_profile_count,
                        api_concurrent_profiles,
                        api_plan_seed,
...
fn wire__crate__api__sync__get_orchard_migration_custom_plan_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "get_orchard_migration_custom_plan",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            let api_concurrent_profiles = <u32>::sse_decode(&mut deserializer);
            let api_plan_seed = <u64>::sse_decode(&mut deserializer);
            let api_simulated_total_zatoshi = <Option<u64>>::sse_decode(&mut deserializer);
            let api_space_preparation_broadcasts = <bool>::sse_decode(&mut deserializer);
            deserializer.end();
            move |context| {
                transform_result_sse::<_, String>((move || {
                    let output_ok = crate::api::sync::get_orchard_migration_custom_plan(
                        api_db_path,
                        api_network,
                        api_account_uuid,
                        api_profile_count,
...
impl SseDecode for crate::api::sync::OrchardMigrationPrivatePlan {
    ...
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        ...
        let mut var_customProfileCount = <Option<u32>>::sse_decode(deserializer);
        let mut var_customConcurrentProfiles = <Option<u32>>::sse_decode(deserializer);
        let mut var_customPlanSeed = <Option<u64>>::sse_decode(deserializer);
        let mut var_isSimulated = <bool>::sse_decode(deserializer);
        return crate::api::sync::OrchardMigrationPrivatePlan {
            ...
            custom_profile_count: var_customProfileCount,
            custom_concurrent_profiles: var_customConcurrentProfiles,
            custom_plan_seed: var_customPlanSeed,
            is_simulated: var_isSimulated,
        };
    }
}
...
22 => wire__crate__api__sync__create_or_resume_custom_migration_draft_impl(port, ptr, rust_vec_len, data_len),
...
72 => wire__crate__api__sync__get_orchard_migration_custom_plan_impl(port, ptr, rust_vec_len, data_len),
...
impl flutter_rust_bridge::IntoDart for crate::api::sync::OrchardMigrationPrivatePlan {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        [
            ...
            self.custom_profile_count.into_into_dart().into_dart(),
            self.custom_concurrent_profiles.into_into_dart().into_dart(),
            self.custom_plan_seed.into_into_dart().into_dart(),
            self.is_simulated.into_into_dart().into_dart(),
        ]
        .into_dart()
    }
}
...
impl SseEncode for crate::api::sync::OrchardMigrationPrivatePlan {
    ...
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        ...
        <Option<u32>>::sse_encode(self.custom_profile_count, serializer);
        <Option<u32>>::sse_encode(self.custom_concurrent_profiles, serializer);
        <Option<u64>>::sse_encode(self.custom_plan_seed, serializer);
        <bool>::sse_encode(self.is_simulated, serializer);
    }
}
