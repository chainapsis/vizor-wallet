...
void main() {
  test('a Ledger swapped during USB signing asks for one Ledger', () {
    final guidance = ledgerFailureGuidance(
      StateError(ledgerSigningAppChangedError),
    );
    expect(guidance?.message, ledgerSigningAppChangedError);
