...
Use when changing claim settlement, card availability, competition, or legacy recovery-record interpretation.

Implementation: [claim service](../../../../lib/src/features/payment_links/services/payment_link_service.dart)
and [received records](../../../../lib/src/features/payment_links/services/payment_link_received_store.dart).
Verify with the [service tests](../../../../test/features/payment_links/payment_link_service_test.dart)
and [record tests](../../../../test/features/payment_links/payment_link_received_store_test.dart).
