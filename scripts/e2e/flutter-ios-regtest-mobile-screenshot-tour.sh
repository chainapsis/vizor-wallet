...
SHOT_DIR="${E2E_SCREENSHOT_DIR:-$ROOT_DIR/.regtest-logs/screens}"
SHOT_LOG="$ROOT_DIR/.regtest-logs/screenshot-driver.log"
...
run_mobile_e2e integration_test/regtest_mobile_screenshot_tour_test.dart "$UDID" \
  --dart-define=ZCASH_E2E_SCREENSHOT_DRIVER_URL="http://127.0.0.1:${SHOT_PORT}"

echo "screens captured under $SHOT_DIR"
