...
internal39="$(json_field "$addresses_json" internal39)"

fund_transparent "m/44'/133'/0'/0/0" "$external0" "0.11"
fund_transparent "m/44'/133'/0'/0/19" "$external19" "0.12"
fund_transparent "m/44'/133'/0'/0/39" "$external39" "0.13"
fund_transparent "m/44'/133'/0'/1/19" "$internal19" "0.14"
fund_transparent "m/44'/133'/0'/1/39" "$internal39" "0.15"
