...
param(
  ...
  [string]$MultisigCoordinatorUrl = $env:ZCASH_MULTISIG_COORDINATOR_URL,
...
if ([string]::IsNullOrWhiteSpace($MultisigCoordinatorUrl)) {
  $MultisigCoordinatorUrl = "http://zcash-multisig-coordinator2-dev-764987680.us-west-2.elb.amazonaws.com"
}
...
$flutterBuildArgs = @(
  ...
  "--dart-define=ZCASH_MULTISIG_COORDINATOR_URL=$MultisigCoordinatorUrl"
)
