...
FUNDING_AMOUNT="${1:-10000000.0002}"
CHECKPOINT_NAME="${2:-custom-migration-10000000-zec}"
EXPECTED_GRANT_ZATOSHI=1100000000000000
...
if zatoshis != zatoshis.to_integral_value() or not (0 < zatoshis < 11_000_000 * 100_000_000):
    raise SystemExit("funding amount must be positive, below 11,000,000 ZEC, and have at most 8 decimals")
print(int(zatoshis))
PY
)"
