...
/// Drives the one-shot `NEW` marker for the mobile Pay introduction.
///
/// Desktop uses [PayIntroductionBadgeTarget]'s activation and hover behavior;
/// mobile has no hover surface, so it consumes the same persisted introduction
/// state when the Home callout is first shown.
