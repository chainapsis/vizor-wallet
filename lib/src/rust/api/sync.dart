...
class OrchardMigrationPrivatePlan {
  ...
  final int? customAmountGroupCount;

  /// Parallel broadcast schedules used by Custom migration.
  final int? customParallelScheduleCount;
  ...
  const OrchardMigrationPrivatePlan({
    ...
    this.customAmountGroupCount,
    this.customParallelScheduleCount,
    this.customPlanSeed,
  });
  ...
  int get hashCode =>
      ...
      customAmountGroupCount.hashCode ^
      customParallelScheduleCount.hashCode ^
  ...
  bool operator ==(Object other) =>
      ...
      other is OrchardMigrationPrivatePlan &&
          ...
          customAmountGroupCount == other.customAmountGroupCount &&
          customParallelScheduleCount == other.customParallelScheduleCount &&
