...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -2019732922;
...
abstract class RustLibApi extends BaseApi {
  ...
  ApiMultisigBackupPassword crateApiMultisigGenerateMultisigBackupPassword();
  ...
  crateApiMultisigPostMultisigBroadcastResult({
    required String coordinatorUrl,
    required String sessionId,
    required String signingRequestId,
    required String participantId,
  ...
  Future<ApiMultisigSigningAdvance>
  crateApiMultisigSubmitMultisigSigningRound2({
    required String coordinatorUrl,
    required String sessionId,
    required String signingRequestId,
    required String participantId,
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  ApiMultisigBackupPassword crateApiMultisigGenerateMultisigBackupPassword() {
    return handler.executeSync(
      SyncTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_api_multisig_backup_password,
          decodeErrorData: null,
        ),
        constMeta: kCrateApiMultisigGenerateMultisigBackupPasswordConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiMultisigGenerateMultisigBackupPasswordConstMeta =>
      const TaskConstMeta(
        debugName: "generate_multisig_backup_password",
        argNames: [],
      );
    ...
    return handler.executeSync(
      SyncTask(
        callFfi: () {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_String(password, serializer);
          sse_encode_bool(generated, serializer);
  ...
  crateApiMultisigPostMultisigBroadcastResult({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiMultisigPostMultisigBroadcastResultConstMeta,
        argValues: [
          coordinatorUrl,
          sessionId,
          signingRequestId,
  ...
  TaskConstMeta get kCrateApiMultisigPostMultisigBroadcastResultConstMeta =>
      const TaskConstMeta(
        debugName: "post_multisig_broadcast_result",
        argNames: [
          "coordinatorUrl",
          "sessionId",
          "signingRequestId",
  ...
  TaskConstMeta get kCrateApiMultisigSubmitMultisigSigningRound1ConstMeta =>
      const TaskConstMeta(
  ...
  crateApiMultisigSubmitMultisigSigningRound2({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiMultisigSubmitMultisigSigningRound2ConstMeta,
        argValues: [
          coordinatorUrl,
          sessionId,
          signingRequestId,
  ...
  TaskConstMeta get kCrateApiMultisigSubmitMultisigSigningRound2ConstMeta =>
      const TaskConstMeta(
        debugName: "submit_multisig_signing_round2",
        argNames: [
          "coordinatorUrl",
          "sessionId",
          "signingRequestId",
  ...
  ApiMultisigBackupPassword dco_decode_api_multisig_backup_password(
    ...
    if (arr.length != 3)
      throw Exception('unexpected arr length: expect 3 but see ${arr.length}');
    return ApiMultisigBackupPassword(
      displayPassword: dco_decode_String(arr[0]),
      canonicalPassword: dco_decode_String(arr[1]),
  ...
  ApiMultisigBackupPassword sse_decode_api_multisig_backup_password(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_displayPassword = sse_decode_String(deserializer);
    var var_canonicalPassword = sse_decode_String(deserializer);
    var var_checksum = sse_decode_String(deserializer);
    return ApiMultisigBackupPassword(
      displayPassword: var_displayPassword,
      canonicalPassword: var_canonicalPassword,
  ...
  void sse_encode_api_multisig_backup_password(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_String(self.displayPassword, serializer);
    sse_encode_String(self.canonicalPassword, serializer);
