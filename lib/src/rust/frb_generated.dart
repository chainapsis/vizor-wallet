...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -1782742575;
...
abstract class RustLibApi extends BaseApi {
  ...
  bool crateApiSyncIsPaymentLinkClaimSyncRunning({required String claimId});
  ...
  Stream<ApiSyncProgressEvent> crateApiSyncStartPaymentLinkClaimSync({
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  bool crateApiSyncIsPaymentLinkClaimSyncRunning({required String claimId}) {
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateApiSyncIsPaymentLinkClaimSyncRunningConstMeta,
        argValues: [claimId],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiSyncIsPaymentLinkClaimSyncRunningConstMeta =>
      const TaskConstMeta(
        debugName: "is_payment_link_claim_sync_running",
        argNames: ["claimId"],
      );
    ...
    unawaited(
      handler.executeNormal(
        NormalTask(
          ...
          constMeta: kCrateApiSyncStartPaymentLinkClaimSyncConstMeta,
          argValues: [claimId, dbPath, lightwalletdUrl, network, sink],
          apiImpl: this,
        ),
      ),
    );
  ...
  TaskConstMeta get kCrateApiSyncStartPaymentLinkClaimSyncConstMeta =>
      const TaskConstMeta(
        debugName: "start_payment_link_claim_sync",
        argNames: ["claimId", "dbPath", "lightwalletdUrl", "network", "sink"],
      );
