...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 825544125;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<String> crateApiPaymentUriParseCrossChainPaymentUri({
    required String uri,
  });
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<String> crateApiPaymentUriParseCrossChainPaymentUri({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiPaymentUriParseCrossChainPaymentUriConstMeta,
        argValues: [uri],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiPaymentUriParseCrossChainPaymentUriConstMeta =>
      const TaskConstMeta(
        debugName: "parse_cross_chain_payment_uri",
        argNames: ["uri"],
      );
