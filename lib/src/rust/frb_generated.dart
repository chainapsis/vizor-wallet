...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -765757958;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<ApiPrivateStateRequestAuthorization>
  crateApiPrivateStateSyncAuthorizePrivateStateRequest({
    required String dbPath,
    required String network,
    required String accountUuid,
  ...
  Future<ApiPrivateStateObjectReference>
  ...
  Future<void> crateApiNetworkPrivacyEnsurePrivateStateTor({
    required String torDirectory,
  });
  ...
  Future<Uint8List> crateApiPrivateStateSyncOpenPrivateStateObject({
    required String dbPath,
    required String network,
    required String accountUuid,
    required String namespace,
  ...
  Future<NetworkHttpResponse> crateApiNetworkPrivacyPrivateStateTorHttpGet({
    required String url,
    required List<NetworkHttpHeader> headers,
  });

  Future<NetworkHttpResponse> crateApiNetworkPrivacyPrivateStateTorHttpPost({
    required String url,
    required List<NetworkHttpHeader> headers,
  ...
  Future<ApiPrivateStateEnvelope>
  crateApiPrivateStateSyncSealPrivateStateObject({
    required String dbPath,
    required String network,
    required String accountUuid,
    required String namespace,
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  crateApiPrivateStateSyncAuthorizePrivateStateRequest({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_api_private_state_request_authorization,
          decodeErrorData: sse_decode_String,
        ),
        constMeta:
            kCrateApiPrivateStateSyncAuthorizePrivateStateRequestConstMeta,
        argValues: [
          dbPath,
          network,
          accountUuid,
  ...
  TaskConstMeta
  get kCrateApiPrivateStateSyncAuthorizePrivateStateRequestConstMeta =>
      const TaskConstMeta(
        debugName: "authorize_private_state_request",
        argNames: [
          "dbPath",
          "network",
          "accountUuid",
  ...
  crateApiPrivateStateSyncDerivePrivateStateObjectReference({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_api_private_state_object_reference,
          decodeErrorData: sse_decode_String,
        ),
        constMeta:
            kCrateApiPrivateStateSyncDerivePrivateStateObjectReferenceConstMeta,
        argValues: [dbPath, network, accountUuid, namespace, itemKey],
        apiImpl: this,
      ),
    );
  }
  ...
  TaskConstMeta
  get kCrateApiPrivateStateSyncDerivePrivateStateObjectReferenceConstMeta =>
      const TaskConstMeta(
        debugName: "derive_private_state_object_reference",
        argNames: ["dbPath", "network", "accountUuid", "namespace", "itemKey"],
      );
  ...
  Future<void> crateApiNetworkPrivacyEnsurePrivateStateTor({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiNetworkPrivacyEnsurePrivateStateTorConstMeta,
        argValues: [torDirectory],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiNetworkPrivacyEnsurePrivateStateTorConstMeta =>
      const TaskConstMeta(
        debugName: "ensure_private_state_tor",
        argNames: ["torDirectory"],
      );
  ...
  Future<Uint8List> crateApiPrivateStateSyncOpenPrivateStateObject({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiPrivateStateSyncOpenPrivateStateObjectConstMeta,
        argValues: [dbPath, network, accountUuid, namespace, itemKey, envelope],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiPrivateStateSyncOpenPrivateStateObjectConstMeta =>
      const TaskConstMeta(
        debugName: "open_private_state_object",
        argNames: [
          "dbPath",
          "network",
          "accountUuid",
  ...
  Future<NetworkHttpResponse> crateApiNetworkPrivacyPrivateStateTorHttpGet({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiNetworkPrivacyPrivateStateTorHttpGetConstMeta,
  ...
  TaskConstMeta get kCrateApiNetworkPrivacyPrivateStateTorHttpGetConstMeta =>
      const TaskConstMeta(
        debugName: "private_state_tor_http_get",
  ...
  Future<NetworkHttpResponse> crateApiNetworkPrivacyPrivateStateTorHttpPost({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiNetworkPrivacyPrivateStateTorHttpPostConstMeta,
  ...
  TaskConstMeta get kCrateApiNetworkPrivacyPrivateStateTorHttpPostConstMeta =>
      const TaskConstMeta(
        debugName: "private_state_tor_http_post",
  ...
  crateApiPrivateStateSyncSealPrivateStateObject({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_api_private_state_envelope,
          decodeErrorData: sse_decode_String,
        ),
        constMeta: kCrateApiPrivateStateSyncSealPrivateStateObjectConstMeta,
        argValues: [
          dbPath,
          network,
          accountUuid,
  ...
  TaskConstMeta get kCrateApiPrivateStateSyncSealPrivateStateObjectConstMeta =>
      const TaskConstMeta(
        debugName: "seal_private_state_object",
        argNames: [
          "dbPath",
          "network",
          "accountUuid",
  ...
  ApiPrivateStateObjectReference dco_decode_api_private_state_object_reference(
    ...
    if (arr.length != 3)
      throw Exception('unexpected arr length: expect 3 but see ${arr.length}');
    return ApiPrivateStateObjectReference(
      protocolVersion: dco_decode_u_32(arr[0]),
      objectId: dco_decode_String(arr[1]),
      authPublicKeyBase64: dco_decode_String(arr[2]),
    );
  ...
  dco_decode_api_private_state_request_authorization(dynamic raw) {
    ...
    return ApiPrivateStateRequestAuthorization(
      protocolVersion: dco_decode_u_32(arr[0]),
      objectId: dco_decode_String(arr[1]),
      authPublicKeyBase64: dco_decode_String(arr[2]),
      ...
      signatureBase64: dco_decode_String(arr[8]),
    );
  }
  ...
  void sse_encode_box_autoadd_api_private_state_envelope(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_api_private_state_envelope(self, serializer);
  }
