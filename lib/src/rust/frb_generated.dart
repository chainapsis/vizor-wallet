...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 1297598380;
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<void> crateApiSyncDiscardAllProposalsForWalletReset({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiSyncDiscardAllProposalsForWalletResetConstMeta,
        argValues: [dbPath],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiSyncDiscardAllProposalsForWalletResetConstMeta =>
      const TaskConstMeta(
        debugName: "discard_all_proposals_for_wallet_reset",
        argNames: ["dbPath"],
      );
