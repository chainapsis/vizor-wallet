...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 1087623681;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<String> crateApiSyncCreateOrResumeCustomMigrationDraft({
    required String dbPath,
    required String network,
    required String accountUuid,
  ...
  crateApiSyncGetOrchardMigrationCustomPlan({
    required String dbPath,
    required String network,
    required String accountUuid,
    required int profileCount,
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_String(network, serializer);
          sse_encode_String(accountUuid, serializer);
          sse_encode_list_prim_u_64_strict(targetValuesZatoshi, serializer);
          sse_encode_list_migration_scheduled_transfer(
            approvedSchedule,
            serializer,
          );
          sse_encode_u_32(profileCount, serializer);
          sse_encode_u_32(concurrentProfiles, serializer);
          sse_encode_u_64(planSeed, serializer);
        ...
        constMeta: kCrateApiSyncCreateOrResumeCustomMigrationDraftConstMeta,
        argValues: [
          dbPath,
          network,
          accountUuid,
  ...
  TaskConstMeta get kCrateApiSyncCreateOrResumeCustomMigrationDraftConstMeta =>
      const TaskConstMeta(
        debugName: "create_or_resume_custom_migration_draft",
        argNames: [
          "dbPath",
          "network",
          "accountUuid",
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_u_32(concurrentProfiles, serializer);
          sse_encode_u_64(planSeed, serializer);
          sse_encode_opt_box_autoadd_u_64(simulatedTotalZatoshi, serializer);
          sse_encode_bool(spacePreparationBroadcasts, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
        ...
        constMeta: kCrateApiSyncGetOrchardMigrationCustomPlanConstMeta,
        argValues: [
          dbPath,
          network,
          accountUuid,
  ...
  TaskConstMeta get kCrateApiSyncGetOrchardMigrationCustomPlanConstMeta =>
      const TaskConstMeta(
        debugName: "get_orchard_migration_custom_plan",
        argNames: [
          "dbPath",
          "network",
          "accountUuid",
  ...
  OrchardMigrationPrivatePlan dco_decode_orchard_migration_private_plan(
    ...
    return OrchardMigrationPrivatePlan(
      ...
      customProfileCount: dco_decode_opt_box_autoadd_u_32(arr[16]),
      customConcurrentProfiles: dco_decode_opt_box_autoadd_u_32(arr[17]),
      customPlanSeed: dco_decode_opt_box_autoadd_u_64(arr[18]),
      isSimulated: dco_decode_bool(arr[19]),
    );
  }
  ...
  OrchardMigrationPrivatePlan sse_decode_orchard_migration_private_plan(
    ...
    var var_customProfileCount = sse_decode_opt_box_autoadd_u_32(deserializer);
    var var_customConcurrentProfiles = sse_decode_opt_box_autoadd_u_32(
      deserializer,
    );
    var var_customPlanSeed = sse_decode_opt_box_autoadd_u_64(deserializer);
    var var_isSimulated = sse_decode_bool(deserializer);
    return OrchardMigrationPrivatePlan(
      targetValuesZatoshi: var_targetValuesZatoshi,
      totalInputZatoshi: var_totalInputZatoshi,
      ...
      customProfileCount: var_customProfileCount,
      customConcurrentProfiles: var_customConcurrentProfiles,
      customPlanSeed: var_customPlanSeed,
      isSimulated: var_isSimulated,
    );
  }
  ...
  void sse_encode_orchard_migration_private_plan(
    ...
    sse_encode_opt_box_autoadd_u_32(self.customProfileCount, serializer);
    sse_encode_opt_box_autoadd_u_32(self.customConcurrentProfiles, serializer);
    sse_encode_opt_box_autoadd_u_64(self.customPlanSeed, serializer);
    sse_encode_bool(self.isSimulated, serializer);
  }
