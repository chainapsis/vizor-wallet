...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -1069600738;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<bool> crateApiLedgerLedgerDiscardSignedOperation({
    required String dbPath,
    required String network,
    required String operationId,
  });
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<bool> crateApiLedgerLedgerDiscardSignedOperation({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiLedgerLedgerDiscardSignedOperationConstMeta,
        argValues: [dbPath, network, operationId],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiLedgerLedgerDiscardSignedOperationConstMeta =>
      const TaskConstMeta(
        debugName: "ledger_discard_signed_operation",
        argNames: ["dbPath", "network", "operationId"],
      );
  ...
  LedgerWalletIdentity dco_decode_ledger_wallet_identity(dynamic raw) {
    ...
    if (arr.length != 1)
      throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
    return LedgerWalletIdentity(fingerprint: dco_decode_String(arr[0]));
  }
  ...
  LedgerWalletIdentity sse_decode_ledger_wallet_identity(
    ...
    return LedgerWalletIdentity(fingerprint: var_fingerprint);
  }
