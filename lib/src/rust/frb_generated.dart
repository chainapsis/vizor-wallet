...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -371208355;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<IronwoodMigrationResult>
  crateApiSyncFinishOrchardMigrationImmediately({
    required String dbPath,
    required String lightwalletdUrl,
    required String network,
    required String accountUuid,
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  crateApiSyncFinishOrchardMigrationImmediately({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiSyncFinishOrchardMigrationImmediatelyConstMeta,
        argValues: [
          dbPath,
          lightwalletdUrl,
          network,
  ...
  TaskConstMeta get kCrateApiSyncFinishOrchardMigrationImmediatelyConstMeta =>
      const TaskConstMeta(
        debugName: "finish_orchard_migration_immediately",
        argNames: [
          "dbPath",
          "lightwalletdUrl",
          "network",
