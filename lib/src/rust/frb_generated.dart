...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 256508370;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<ApiMultisigCreateAdvance> crateApiMultisigAdvanceMultisigCreate({
  ...
  Future<ApiMultisigSignedPczt> crateApiMultisigAggregateMultisigSignedPczt({
    required String coordinatorUrl,
    required String sessionId,
  ...
  Future<ApiMultisigAuthSession> crateApiMultisigCreateMultisigSession({
    required String coordinatorUrl,
    required String admissionSecretKey,
    required String deliverySecretKey,
    required String inviteSecret,
  ...
  Future<ApiMultisigBackupArtifact> crateApiMultisigCreateMultisigShareBackup({
    required String network,
    required String sessionId,
    required String participantId,
    required int threshold,
  ...
  String crateApiMultisigDeriveMultisigSessionId({
    required String inviteSecret,
  });
  ...
  Future<ApiMultisigOutboxDispatch>
  crateApiMultisigDispatchMultisigCreateOutbox({
    required String coordinatorUrl,
    required String sessionId,
    required String participantId,
    required String accessToken,
  ...
  crateApiMultisigDispatchMultisigSigningOutbox({
    required String coordinatorUrl,
    required String signingRequestId,
    required String participantId,
    required String accessToken,
  ...
  String crateApiMultisigGenerateMultisigInviteSecret();

  ApiMultisigParticipantIdentity
  crateApiMultisigGenerateMultisigParticipantIdentity();
  ...
  Future<ApiMultisigSession> crateApiMultisigGetMultisigSession({
    required String coordinatorUrl,
    required String sessionId,
    required String accessToken,
    required String inviteSecret,
  ...
  Future<ApiMultisigSessionEvents> crateApiMultisigGetMultisigSessionEvents({
    required String coordinatorUrl,
    required String sessionId,
    required String accessToken,
  ...
  Future<ApiMultisigSession> crateApiMultisigGetMultisigSessionRoster({
    required String coordinatorUrl,
    required String sessionId,
    required String accessToken,
  });
  ...
  Future<ApiMultisigSigningRequest> crateApiMultisigGetMultisigSigningRequest({
    required String coordinatorUrl,
    required String signingRequestId,
    required String accessToken,
    required String pcztHash,
  ...
  Future<AccountCreationResult> crateApiWalletImportMultisigAccount({
    required String dbPath,
    required String network,
    required String name,
    required String groupPublicPackageJson,
  ...
  Future<ApiMultisigAuthSession> crateApiMultisigJoinMultisigSession({
    required String coordinatorUrl,
    required String sessionId,
    required String admissionSecretKey,
    required String deliverySecretKey,
  ...
  Future<ApiMultisigSession> crateApiMultisigLockMultisigSession({
    required String coordinatorUrl,
    required String sessionId,
    required String accessToken,
    required String inviteSecret,
  ...
  String crateApiMultisigNormalizeMultisigBackupPassword({
    required String password,
  ...
  Future<void> crateApiMultisigPostMultisigVaultLabel({
    required String coordinatorUrl,
    required String sessionId,
    required String participantId,
    required String accessToken,
  ...
  Future<ApiMultisigSigningAdvance>
  crateApiMultisigPrepareMultisigBroadcastResult({
    required String coordinatorUrl,
    required String sessionId,
    required String signingRequestId,
    required String participantId,
  ...
  Future<ApiMultisigSigningAdvance>
  crateApiMultisigPrepareMultisigSigningRound1({
    required String coordinatorUrl,
    required String network,
    required String sessionId,
    required String signingRequestId,
  ...
  Future<ApiMultisigSigningAdvance>
  crateApiMultisigPrepareMultisigSigningRound2({
    required String coordinatorUrl,
    required String sessionId,
    required String signingRequestId,
    required String participantId,
  ...
  Future<ApiMultisigTokens> crateApiMultisigRefreshMultisigAuth({
    required String coordinatorUrl,
    required String refreshToken,
  });

  Future<ApiMultisigAuthUpdate> crateApiMultisigRefreshOrResumeMultisigAuth({
    required String coordinatorUrl,
    required String sessionId,
    required String participantId,
    required String refreshToken,
  ...
  ApiMultisigParticipantIdentity
  crateApiMultisigRestoreMultisigParticipantIdentity({
    required String admissionSecretKey,
    required String deliverySecretKey,
  });

  Future<ApiMultisigBackupVerification>
  crateApiMultisigRestoreMultisigShareBackup({
    required String network,
    required String artifactJson,
    required String passphrase,
  });

  Future<ApiMultisigAuthSession> crateApiMultisigResumeMultisigParticipant({
    required String coordinatorUrl,
    required String sessionId,
    required String admissionSecretKey,
    required String deliverySecretKey,
  ...
  Future<ApiMultisigSigningRequest>
  crateApiMultisigSubmitPreparedMultisigSigningRequest({
    required String coordinatorUrl,
    required String sessionId,
    required String accessToken,
    required String pcztHash,
  ...
  ApiMultisigThresholdParams crateApiMultisigValidateMultisigThreshold({
    required int threshold,
    required int participantCount,
  });

  Future<ApiMultisigBackupVerification>
  crateApiMultisigVerifyMultisigShareBackup({
    required String network,
    required String artifactJson,
    required String passphrase,
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<ApiMultisigCreateAdvance> crateApiMultisigAdvanceMultisigCreate({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_api_multisig_create_advance,
          decodeErrorData: sse_decode_String,
        ),
        constMeta: kCrateApiMultisigAdvanceMultisigCreateConstMeta,
        argValues: [
          coordinatorUrl,
          sessionId,
          participantId,
  ...
  TaskConstMeta get kCrateApiMultisigAdvanceMultisigCreateConstMeta =>
      const TaskConstMeta(
        debugName: "advance_multisig_create",
        argNames: [
          "coordinatorUrl",
          "sessionId",
          "participantId",
  ...
  Future<ApiMultisigSignedPczt> crateApiMultisigAggregateMultisigSignedPczt({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_api_multisig_signed_pczt,
          decodeErrorData: sse_decode_String,
        ),
        constMeta: kCrateApiMultisigAggregateMultisigSignedPcztConstMeta,
        argValues: [
          coordinatorUrl,
          sessionId,
          signingRequestId,
  ...
  TaskConstMeta get kCrateApiMultisigAggregateMultisigSignedPcztConstMeta =>
      const TaskConstMeta(
        debugName: "aggregate_multisig_signed_pczt",
        argNames: [
          "coordinatorUrl",
          "sessionId",
          "signingRequestId",
  ...
  Future<ApiMultisigAuthSession> crateApiMultisigCreateMultisigSession({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_api_multisig_auth_session,
          decodeErrorData: sse_decode_String,
        ),
        constMeta: kCrateApiMultisigCreateMultisigSessionConstMeta,
        argValues: [
          coordinatorUrl,
          admissionSecretKey,
          deliverySecretKey,
  ...
  TaskConstMeta get kCrateApiMultisigCreateMultisigSessionConstMeta =>
      const TaskConstMeta(
        debugName: "create_multisig_session",
        argNames: [
          "coordinatorUrl",
          "admissionSecretKey",
          "deliverySecretKey",
  ...
  Future<ApiMultisigBackupArtifact> crateApiMultisigCreateMultisigShareBackup({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_api_multisig_backup_artifact,
          decodeErrorData: sse_decode_String,
        ),
        constMeta: kCrateApiMultisigCreateMultisigShareBackupConstMeta,
        argValues: [
          network,
          sessionId,
          participantId,
  ...
  TaskConstMeta get kCrateApiMultisigCreateMultisigShareBackupConstMeta =>
      const TaskConstMeta(
        debugName: "create_multisig_share_backup",
        argNames: [
          "network",
          "sessionId",
          "participantId",
  ...
  String crateApiMultisigDeriveMultisigSessionId({
    ...
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateApiMultisigDeriveMultisigSessionIdConstMeta,
        argValues: [inviteSecret],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiMultisigDeriveMultisigSessionIdConstMeta =>
      const TaskConstMeta(
        debugName: "derive_multisig_session_id",
        argNames: ["inviteSecret"],
      );
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_String(participantId, serializer);
          sse_encode_String(accessToken, serializer);
          sse_encode_String(localStateJson, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
            funcId: 35,
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_api_multisig_outbox_dispatch,
          decodeErrorData: sse_decode_String,
        ),
        constMeta: kCrateApiMultisigDispatchMultisigCreateOutboxConstMeta,
        argValues: [
          coordinatorUrl,
          sessionId,
          participantId,
  ...
  TaskConstMeta get kCrateApiMultisigDispatchMultisigCreateOutboxConstMeta =>
      const TaskConstMeta(
        debugName: "dispatch_multisig_create_outbox",
        argNames: [
          "coordinatorUrl",
          "sessionId",
          "participantId",
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_String(participantId, serializer);
          sse_encode_String(accessToken, serializer);
          sse_encode_String(pcztHash, serializer);
          sse_encode_String(localStateJson, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_api_multisig_signing_advance,
          decodeErrorData: sse_decode_String,
        ),
        constMeta: kCrateApiMultisigDispatchMultisigSigningOutboxConstMeta,
        argValues: [
          coordinatorUrl,
          signingRequestId,
          participantId,
  ...
  TaskConstMeta get kCrateApiMultisigDispatchMultisigSigningOutboxConstMeta =>
      const TaskConstMeta(
        debugName: "dispatch_multisig_signing_outbox",
        argNames: [
          "coordinatorUrl",
          "signingRequestId",
          "participantId",
  ...
  String crateApiMultisigGenerateMultisigInviteSecret() {
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateApiMultisigGenerateMultisigInviteSecretConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiMultisigGenerateMultisigInviteSecretConstMeta =>
      const TaskConstMeta(
        debugName: "generate_multisig_invite_secret",
        argNames: [],
      );
  ...
  crateApiMultisigGenerateMultisigParticipantIdentity() {
    return handler.executeSync(
      SyncTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_api_multisig_participant_identity,
          decodeErrorData: null,
        ),
        constMeta:
            kCrateApiMultisigGenerateMultisigParticipantIdentityConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiMultisigGenerateMultisigParticipantIdentityConstMeta =>
      const TaskConstMeta(
        debugName: "generate_multisig_participant_identity",
        argNames: [],
      );
  ...
  Future<ApiMultisigSession> crateApiMultisigGetMultisigSession({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_api_multisig_session,
          decodeErrorData: sse_decode_String,
        ),
        constMeta: kCrateApiMultisigGetMultisigSessionConstMeta,
  ...
  TaskConstMeta get kCrateApiMultisigGetMultisigSessionConstMeta =>
      const TaskConstMeta(
        debugName: "get_multisig_session",
        argNames: [
          "coordinatorUrl",
          "sessionId",
          "accessToken",
  ...
  Future<ApiMultisigSessionEvents> crateApiMultisigGetMultisigSessionEvents({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_api_multisig_session_events,
          decodeErrorData: sse_decode_String,
        ),
        constMeta: kCrateApiMultisigGetMultisigSessionEventsConstMeta,
        argValues: [coordinatorUrl, sessionId, accessToken, after],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiMultisigGetMultisigSessionEventsConstMeta =>
      const TaskConstMeta(
        debugName: "get_multisig_session_events",
        argNames: ["coordinatorUrl", "sessionId", "accessToken", "after"],
      );
  ...
  Future<ApiMultisigSession> crateApiMultisigGetMultisigSessionRoster({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiMultisigGetMultisigSessionRosterConstMeta,
        argValues: [coordinatorUrl, sessionId, accessToken],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiMultisigGetMultisigSessionRosterConstMeta =>
      const TaskConstMeta(
        debugName: "get_multisig_session_roster",
        argNames: ["coordinatorUrl", "sessionId", "accessToken"],
      );
  ...
  Future<ApiMultisigSigningInbox> crateApiMultisigGetMultisigSigningInbox({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_api_multisig_signing_inbox,
          decodeErrorData: sse_decode_String,
        ),
  ...
  TaskConstMeta get kCrateApiMultisigGetMultisigSigningInboxConstMeta =>
      const TaskConstMeta(
  ...
  Future<ApiMultisigSigningRequest> crateApiMultisigGetMultisigSigningRequest({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_api_multisig_signing_request,
          decodeErrorData: sse_decode_String,
        ),
        constMeta: kCrateApiMultisigGetMultisigSigningRequestConstMeta,
        argValues: [coordinatorUrl, signingRequestId, accessToken, pcztHash],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiMultisigGetMultisigSigningRequestConstMeta =>
      const TaskConstMeta(
        debugName: "get_multisig_signing_request",
        argNames: [
          "coordinatorUrl",
          "signingRequestId",
          "accessToken",
  ...
  Future<AccountCreationResult> crateApiWalletImportMultisigAccount({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiWalletImportMultisigAccountConstMeta,
        argValues: [
          dbPath,
          network,
          name,
  ...
  TaskConstMeta get kCrateApiWalletImportMultisigAccountConstMeta =>
      const TaskConstMeta(
        debugName: "import_multisig_account",
        argNames: [
          "dbPath",
          "network",
          "name",
  ...
  Future<ApiMultisigAuthSession> crateApiMultisigJoinMultisigSession({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiMultisigJoinMultisigSessionConstMeta,
        argValues: [
          coordinatorUrl,
          sessionId,
          admissionSecretKey,
  ...
  TaskConstMeta get kCrateApiMultisigJoinMultisigSessionConstMeta =>
      const TaskConstMeta(
        debugName: "join_multisig_session",
        argNames: [
          "coordinatorUrl",
          "sessionId",
          "admissionSecretKey",
  ...
  TaskConstMeta get kCrateApiMultisigLockMultisigSessionConstMeta =>
      const TaskConstMeta(
        debugName: "lock_multisig_session",
        argNames: [
          "coordinatorUrl",
          "sessionId",
          "accessToken",
    ...
    return handler.executeSync(
      SyncTask(
        callFfi: () {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_String(password, serializer);
          sse_encode_u_16(minLength, serializer);
        ...
        constMeta: kCrateApiMultisigNormalizeMultisigBackupPasswordConstMeta,
        argValues: [password, minLength],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiMultisigNormalizeMultisigBackupPasswordConstMeta =>
      const TaskConstMeta(
        debugName: "normalize_multisig_backup_password",
        argNames: ["password", "minLength"],
      );
  ...
  Future<void> crateApiMultisigPostMultisigVaultLabel({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiMultisigPostMultisigVaultLabelConstMeta,
        argValues: [
          coordinatorUrl,
          sessionId,
          participantId,
  ...
  TaskConstMeta get kCrateApiMultisigPostMultisigVaultLabelConstMeta =>
      const TaskConstMeta(
        debugName: "post_multisig_vault_label",
        argNames: [
          "coordinatorUrl",
          "sessionId",
          "participantId",
  ...
  crateApiMultisigPrepareMultisigBroadcastResult({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiMultisigPrepareMultisigBroadcastResultConstMeta,
        argValues: [
          coordinatorUrl,
          sessionId,
          signingRequestId,
  ...
  TaskConstMeta get kCrateApiMultisigPrepareMultisigBroadcastResultConstMeta =>
      const TaskConstMeta(
        debugName: "prepare_multisig_broadcast_result",
        argNames: [
          "coordinatorUrl",
          "sessionId",
          "signingRequestId",
  ...
  crateApiMultisigPrepareMultisigSigningRequest({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_api_prepared_multisig_signing_request,
          decodeErrorData: sse_decode_String,
        ),
  ...
  TaskConstMeta get kCrateApiMultisigPrepareMultisigSigningRequestConstMeta =>
      const TaskConstMeta(
  ...
  crateApiMultisigPrepareMultisigSigningRound1({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiMultisigPrepareMultisigSigningRound1ConstMeta,
        argValues: [
          coordinatorUrl,
          network,
          sessionId,
  ...
  TaskConstMeta get kCrateApiMultisigPrepareMultisigSigningRound1ConstMeta =>
      const TaskConstMeta(
        debugName: "prepare_multisig_signing_round1",
        argNames: [
          "coordinatorUrl",
          "network",
          "sessionId",
  ...
  crateApiMultisigPrepareMultisigSigningRound2({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiMultisigPrepareMultisigSigningRound2ConstMeta,
        argValues: [
          coordinatorUrl,
          sessionId,
          signingRequestId,
  ...
  TaskConstMeta get kCrateApiMultisigPrepareMultisigSigningRound2ConstMeta =>
      const TaskConstMeta(
        debugName: "prepare_multisig_signing_round2",
        argNames: [
          "coordinatorUrl",
          "sessionId",
          "signingRequestId",
  ...
  Future<ApiMultisigTokens> crateApiMultisigRefreshMultisigAuth({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_api_multisig_tokens,
          decodeErrorData: sse_decode_String,
        ),
        constMeta: kCrateApiMultisigRefreshMultisigAuthConstMeta,
        argValues: [coordinatorUrl, refreshToken],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiMultisigRefreshMultisigAuthConstMeta =>
      const TaskConstMeta(
        debugName: "refresh_multisig_auth",
        argNames: ["coordinatorUrl", "refreshToken"],
      );
  ...
  Future<ApiMultisigAuthUpdate> crateApiMultisigRefreshOrResumeMultisigAuth({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_api_multisig_auth_update,
          decodeErrorData: sse_decode_String,
        ),
        constMeta: kCrateApiMultisigRefreshOrResumeMultisigAuthConstMeta,
        argValues: [
          coordinatorUrl,
          sessionId,
          participantId,
  ...
  TaskConstMeta get kCrateApiMultisigRefreshOrResumeMultisigAuthConstMeta =>
      const TaskConstMeta(
        debugName: "refresh_or_resume_multisig_auth",
        argNames: [
          "coordinatorUrl",
          "sessionId",
          "participantId",
  ...
  crateApiMultisigRestoreMultisigParticipantIdentity({
    ...
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateApiMultisigRestoreMultisigParticipantIdentityConstMeta,
        argValues: [admissionSecretKey, deliverySecretKey],
        apiImpl: this,
      ),
    );
  }
  ...
  TaskConstMeta
  get kCrateApiMultisigRestoreMultisigParticipantIdentityConstMeta =>
      const TaskConstMeta(
        debugName: "restore_multisig_participant_identity",
        argNames: ["admissionSecretKey", "deliverySecretKey"],
      );
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_String(network, serializer);
          sse_encode_String(artifactJson, serializer);
          sse_encode_String(passphrase, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_api_multisig_backup_verification,
          decodeErrorData: sse_decode_String,
        ),
        constMeta: kCrateApiMultisigRestoreMultisigShareBackupConstMeta,
        argValues: [network, artifactJson, passphrase],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiMultisigRestoreMultisigShareBackupConstMeta =>
      const TaskConstMeta(
        debugName: "restore_multisig_share_backup",
        argNames: ["network", "artifactJson", "passphrase"],
      );
  ...
  Future<ApiMultisigAuthSession> crateApiMultisigResumeMultisigParticipant({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiMultisigResumeMultisigParticipantConstMeta,
        argValues: [
          coordinatorUrl,
          sessionId,
          admissionSecretKey,
  ...
  TaskConstMeta get kCrateApiMultisigResumeMultisigParticipantConstMeta =>
      const TaskConstMeta(
        debugName: "resume_multisig_participant",
        argNames: [
          "coordinatorUrl",
          "sessionId",
          "admissionSecretKey",
  ...
  crateApiMultisigSubmitPreparedMultisigSigningRequest({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta:
            kCrateApiMultisigSubmitPreparedMultisigSigningRequestConstMeta,
        argValues: [
          coordinatorUrl,
          sessionId,
          accessToken,
  ...
  TaskConstMeta
  get kCrateApiMultisigSubmitPreparedMultisigSigningRequestConstMeta =>
      const TaskConstMeta(
        debugName: "submit_prepared_multisig_signing_request",
        argNames: [
          "coordinatorUrl",
          "sessionId",
          "accessToken",
  ...
  ApiMultisigThresholdParams crateApiMultisigValidateMultisigThreshold({
    ...
    return handler.executeSync(
      SyncTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_api_multisig_threshold_params,
          decodeErrorData: sse_decode_String,
        ),
        constMeta: kCrateApiMultisigValidateMultisigThresholdConstMeta,
        argValues: [threshold, participantCount],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiMultisigValidateMultisigThresholdConstMeta =>
      const TaskConstMeta(
        debugName: "validate_multisig_threshold",
        argNames: ["threshold", "participantCount"],
      );
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_String(expectedParticipantId, serializer);
          sse_encode_u_16(expectedThreshold, serializer);
          sse_encode_u_16(expectedParticipantCount, serializer);
          sse_encode_String(expectedRosterHash, serializer);
          sse_encode_String(expectedGroupPublicPackageHash, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
            funcId: 144,
        ...
        constMeta: kCrateApiMultisigVerifyMultisigShareBackupConstMeta,
        argValues: [
          network,
          artifactJson,
          passphrase,
          ...
          expectedRosterHash,
          expectedGroupPublicPackageHash,
        ],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiMultisigVerifyMultisigShareBackupConstMeta =>
      const TaskConstMeta(
        debugName: "verify_multisig_share_backup",
        argNames: [
          "network",
          "artifactJson",
          "passphrase",
  ...
  ApiMultisigAuthUpdate dco_decode_api_multisig_auth_update(dynamic raw) {
    ...
    return ApiMultisigAuthUpdate(
      sessionId: dco_decode_String(arr[0]),
      participantId: dco_decode_String(arr[1]),
      accessToken: dco_decode_String(arr[2]),
      refreshToken: dco_decode_String(arr[3]),
      admissionPublicKey: dco_decode_String(arr[4]),
      deliverySecretKey: dco_decode_String(arr[5]),
      deliveryPublicKey: dco_decode_String(arr[6]),
      accessTokenExpiresAt: dco_decode_u_64(arr[7]),
      refreshTokenExpiresAt: dco_decode_u_64(arr[8]),
      resumed: dco_decode_bool(arr[9]),
    );
  }
  ...
  ApiMultisigBackupArtifact dco_decode_api_multisig_backup_artifact(
    ...
    if (arr.length != 3)
      throw Exception('unexpected arr length: expect 3 but see ${arr.length}');
    return ApiMultisigBackupArtifact(
      artifactJson: dco_decode_String(arr[0]),
      backupHash: dco_decode_String(arr[1]),
      vaultAddress: dco_decode_String(arr[2]),
    );
  }
  ...
  ApiMultisigBackupVerification dco_decode_api_multisig_backup_verification(
    ...
    if (arr.length != 14)
      throw Exception('unexpected arr length: expect 14 but see ${arr.length}');
    return ApiMultisigBackupVerification(
      backupHash: dco_decode_String(arr[0]),
      vaultAddress: dco_decode_String(arr[1]),
      sessionId: dco_decode_String(arr[2]),
      participantId: dco_decode_String(arr[3]),
      threshold: dco_decode_u_16(arr[4]),
      participantCount: dco_decode_u_16(arr[5]),
      rosterHash: dco_decode_String(arr[6]),
      admissionSecretKey: dco_decode_String(arr[7]),
      admissionPublicKey: dco_decode_String(arr[8]),
      deliverySecretKey: dco_decode_String(arr[9]),
      deliveryPublicKey: dco_decode_String(arr[10]),
      keyPackageB64: dco_decode_String(arr[11]),
      groupPublicPackageJson: dco_decode_String(arr[12]),
      groupPublicPackageHash: dco_decode_String(arr[13]),
    );
  }
  ...
  ApiMultisigCreateAdvance dco_decode_api_multisig_create_advance(dynamic raw) {
    ...
    return ApiMultisigCreateAdvance(
      session: dco_decode_api_multisig_session(arr[0]),
      localStateJson: dco_decode_String(arr[1]),
      phase: dco_decode_String(arr[2]),
      detail: dco_decode_String(arr[3]),
      waitingForParticipantIds: dco_decode_list_String(arr[4]),
      round1Count: dco_decode_u_32(arr[5]),
      round2Count: dco_decode_u_32(arr[6]),
      dkgCompleteSubmitted: dco_decode_bool(arr[7]),
      keyPackageB64: dco_decode_opt_String(arr[8]),
      groupPublicPackageJson: dco_decode_opt_String(arr[9]),
      groupPublicPackageHash: dco_decode_opt_String(arr[10]),
    );
  }

  @protected
  ApiMultisigOutboxDispatch dco_decode_api_multisig_outbox_dispatch(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    final arr = raw as List<dynamic>;
    if (arr.length != 3)
      throw Exception('unexpected arr length: expect 3 but see ${arr.length}');
    return ApiMultisigOutboxDispatch(
      localStateJson: dco_decode_String(arr[0]),
      detail: dco_decode_String(arr[1]),
      submitted: dco_decode_bool(arr[2]),
    );
  }
  ...
  ApiMultisigParticipant dco_decode_api_multisig_participant(dynamic raw) {
    ...
    return ApiMultisigParticipant(
      participantId: dco_decode_String(arr[0]),
      label: dco_decode_opt_String(arr[1]),
      admissionPublicKey: dco_decode_String(arr[2]),
      deliveryPublicKey: dco_decode_String(arr[3]),
      joinedAt: dco_decode_u_64(arr[4]),
      dkgCompleted: dco_decode_bool(arr[5]),
    );
  }
  ...
  ApiMultisigParticipantIdentity dco_decode_api_multisig_participant_identity(
    ...
    return ApiMultisigParticipantIdentity(
      admissionSecretKey: dco_decode_String(arr[0]),
      admissionPublicKey: dco_decode_String(arr[1]),
      deliverySecretKey: dco_decode_String(arr[2]),
      deliveryPublicKey: dco_decode_String(arr[3]),
    );
  }
  ...
  @protected
  ApiMultisigSessionEvent dco_decode_api_multisig_session_event(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    final arr = raw as List<dynamic>;
    if (arr.length != 6)
      throw Exception('unexpected arr length: expect 6 but see ${arr.length}');
    return ApiMultisigSessionEvent(
      cursor: dco_decode_i_64(arr[0]),
      sessionId: dco_decode_String(arr[1]),
      kind: dco_decode_String(arr[2]),
      actorParticipantId: dco_decode_opt_String(arr[3]),
  ...
  @protected
  ApiMultisigSessionEvents dco_decode_api_multisig_session_events(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    final arr = raw as List<dynamic>;
    if (arr.length != 2)
      throw Exception('unexpected arr length: expect 2 but see ${arr.length}');
    return ApiMultisigSessionEvents(
      cursor: dco_decode_i_64(arr[0]),
      events: dco_decode_list_api_multisig_session_event(arr[1]),
    );
  }
  ...
  ApiMultisigSignedPczt dco_decode_api_multisig_signed_pczt(dynamic raw) {
    ...
    if (arr.length != 2)
      throw Exception('unexpected arr length: expect 2 but see ${arr.length}');
    return ApiMultisigSignedPczt(
      localStateJson: dco_decode_String(arr[0]),
      signedPcztBytes: dco_decode_list_prim_u_8_strict(arr[1]),
    );
  }
  ...
  ApiMultisigSigningAdvance dco_decode_api_multisig_signing_advance(
    ...
    if (arr.length != 3)
      throw Exception('unexpected arr length: expect 3 but see ${arr.length}');
    return ApiMultisigSigningAdvance(
      localStateJson: dco_decode_String(arr[0]),
      detail: dco_decode_String(arr[1]),
      submitted: dco_decode_bool(arr[2]),
    );
  ...
  ApiMultisigSigningInbox dco_decode_api_multisig_signing_inbox(dynamic raw) {
    ...
    if (arr.length != 2)
      throw Exception('unexpected arr length: expect 2 but see ${arr.length}');
    return ApiMultisigSigningInbox(
      cursor: dco_decode_i_64(arr[0]),
      messages: dco_decode_list_api_multisig_signing_message(arr[1]),
    );
  }
  ...
  ApiMultisigSigningMessage dco_decode_api_multisig_signing_message(
    ...
    return ApiMultisigSigningMessage(
      ...
      fromParticipantId: dco_decode_String(arr[4]),
  ...
  ApiMultisigSigningRequest dco_decode_api_multisig_signing_request(
    ...
    if (arr.length != 11)
      throw Exception('unexpected arr length: expect 11 but see ${arr.length}');
    return ApiMultisigSigningRequest(
      ...
      round1ParticipantIds: dco_decode_list_String(arr[4]),
      round2ParticipantIds: dco_decode_list_String(arr[5]),
      broadcastParticipantIds: dco_decode_list_String(arr[6]),
      state: dco_decode_String(arr[7]),
      createdAt: dco_decode_u_64(arr[8]),
      updatedAt: dco_decode_u_64(arr[9]),
      pcztHash: dco_decode_String(arr[10]),
    );
  }
  ...
  ApiMultisigThresholdParams dco_decode_api_multisig_threshold_params(
    ...
    if (arr.length != 2)
      throw Exception('unexpected arr length: expect 2 but see ${arr.length}');
    return ApiMultisigThresholdParams(
      threshold: dco_decode_u_16(arr[0]),
      participantCount: dco_decode_u_16(arr[1]),
    );
  }
  ...
  ApiMultisigTokens dco_decode_api_multisig_tokens(dynamic raw) {
    ...
    if (arr.length != 6)
      throw Exception('unexpected arr length: expect 6 but see ${arr.length}');
    return ApiMultisigTokens(
      sessionId: dco_decode_String(arr[0]),
      participantId: dco_decode_String(arr[1]),
      accessToken: dco_decode_String(arr[2]),
      refreshToken: dco_decode_String(arr[3]),
      accessTokenExpiresAt: dco_decode_u_64(arr[4]),
      refreshTokenExpiresAt: dco_decode_u_64(arr[5]),
    );
  }
  ...
  List<ApiMultisigParticipant> dco_decode_list_api_multisig_participant(
    ...
    return (raw as List<dynamic>)
        .map(dco_decode_api_multisig_participant)
        .toList();
  }

  @protected
  List<ApiMultisigSessionEvent> dco_decode_list_api_multisig_session_event(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>)
        .map(dco_decode_api_multisig_session_event)
        .toList();
  }
  ...
  List<ApiMultisigSigningMessage> dco_decode_list_api_multisig_signing_message(
    ...
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>)
        .map(dco_decode_api_multisig_signing_message)
        .toList();
  }
  ...
  ApiMultisigAuthSession sse_decode_api_multisig_auth_session(
    ...
    var var_admissionSecretKey = sse_decode_String(deserializer);
    var var_admissionPublicKey = sse_decode_String(deserializer);
    var var_deliverySecretKey = sse_decode_String(deserializer);
    var var_deliveryPublicKey = sse_decode_String(deserializer);
    var var_accessTokenExpiresAt = sse_decode_u_64(deserializer);
    var var_refreshTokenExpiresAt = sse_decode_u_64(deserializer);
    ...
    return ApiMultisigAuthSession(
      ...
      admissionSecretKey: var_admissionSecretKey,
      admissionPublicKey: var_admissionPublicKey,
      deliverySecretKey: var_deliverySecretKey,
      deliveryPublicKey: var_deliveryPublicKey,
      accessTokenExpiresAt: var_accessTokenExpiresAt,
      refreshTokenExpiresAt: var_refreshTokenExpiresAt,
      state: var_state,
  ...
  ApiMultisigBackupArtifact sse_decode_api_multisig_backup_artifact(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_artifactJson = sse_decode_String(deserializer);
    var var_backupHash = sse_decode_String(deserializer);
    var var_vaultAddress = sse_decode_String(deserializer);
    return ApiMultisigBackupArtifact(
      artifactJson: var_artifactJson,
      backupHash: var_backupHash,
  ...
  ApiMultisigBackupVerification sse_decode_api_multisig_backup_verification(
    ...
    var var_participantCount = sse_decode_u_16(deserializer);
    var var_rosterHash = sse_decode_String(deserializer);
    var var_admissionSecretKey = sse_decode_String(deserializer);
    var var_admissionPublicKey = sse_decode_String(deserializer);
    var var_deliverySecretKey = sse_decode_String(deserializer);
    var var_deliveryPublicKey = sse_decode_String(deserializer);
    var var_keyPackageB64 = sse_decode_String(deserializer);
    var var_groupPublicPackageJson = sse_decode_String(deserializer);
    var var_groupPublicPackageHash = sse_decode_String(deserializer);
    return ApiMultisigBackupVerification(
      backupHash: var_backupHash,
      vaultAddress: var_vaultAddress,
      sessionId: var_sessionId,
      ...
      deliverySecretKey: var_deliverySecretKey,
      deliveryPublicKey: var_deliveryPublicKey,
      keyPackageB64: var_keyPackageB64,
      groupPublicPackageJson: var_groupPublicPackageJson,
  ...
  ApiMultisigCreateAdvance sse_decode_api_multisig_create_advance(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_session = sse_decode_api_multisig_session(deserializer);
    var var_localStateJson = sse_decode_String(deserializer);
    var var_phase = sse_decode_String(deserializer);
    var var_detail = sse_decode_String(deserializer);
    var var_waitingForParticipantIds = sse_decode_list_String(deserializer);
    var var_round1Count = sse_decode_u_32(deserializer);
    var var_round2Count = sse_decode_u_32(deserializer);
    var var_dkgCompleteSubmitted = sse_decode_bool(deserializer);
    var var_keyPackageB64 = sse_decode_opt_String(deserializer);
    var var_groupPublicPackageJson = sse_decode_opt_String(deserializer);
    var var_groupPublicPackageHash = sse_decode_opt_String(deserializer);
    return ApiMultisigCreateAdvance(
      session: var_session,
      localStateJson: var_localStateJson,
      phase: var_phase,
      detail: var_detail,
      waitingForParticipantIds: var_waitingForParticipantIds,
      round1Count: var_round1Count,
      round2Count: var_round2Count,
      dkgCompleteSubmitted: var_dkgCompleteSubmitted,
      keyPackageB64: var_keyPackageB64,
      groupPublicPackageJson: var_groupPublicPackageJson,
      groupPublicPackageHash: var_groupPublicPackageHash,
    );
  ...
  @protected
  ApiMultisigOutboxDispatch sse_decode_api_multisig_outbox_dispatch(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_localStateJson = sse_decode_String(deserializer);
  ...
  ApiMultisigParticipant sse_decode_api_multisig_participant(
    ...
    var var_dkgCompleted = sse_decode_bool(deserializer);
    return ApiMultisigParticipant(
      participantId: var_participantId,
      label: var_label,
      admissionPublicKey: var_admissionPublicKey,
  ...
  ApiMultisigSession sse_decode_api_multisig_session(
    ...
    var var_groupPublicPackageHash = sse_decode_opt_String(deserializer);
    var var_participants = sse_decode_list_api_multisig_participant(
      deserializer,
    );
  ...
  @protected
  ApiMultisigSessionEvent sse_decode_api_multisig_session_event(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    ...
    var var_actorParticipantId = sse_decode_opt_String(deserializer);
    ...
    return ApiMultisigSessionEvent(
      ...
      sessionId: var_sessionId,
      kind: var_kind,
      actorParticipantId: var_actorParticipantId,
  ...
  @protected
  ApiMultisigSessionEvents sse_decode_api_multisig_session_events(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_cursor = sse_decode_i_64(deserializer);
    var var_events = sse_decode_list_api_multisig_session_event(deserializer);
    return ApiMultisigSessionEvents(cursor: var_cursor, events: var_events);
  }
  ...
  ApiMultisigSigningInbox sse_decode_api_multisig_signing_inbox(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_cursor = sse_decode_i_64(deserializer);
    var var_messages = sse_decode_list_api_multisig_signing_message(
      deserializer,
    );
    return ApiMultisigSigningInbox(cursor: var_cursor, messages: var_messages);
  }
  ...
  ApiMultisigSigningRequest sse_decode_api_multisig_signing_request(
    ...
    var var_round1ParticipantIds = sse_decode_list_String(deserializer);
    var var_round2ParticipantIds = sse_decode_list_String(deserializer);
    var var_broadcastParticipantIds = sse_decode_list_String(deserializer);
    var var_state = sse_decode_String(deserializer);
    var var_createdAt = sse_decode_u_64(deserializer);
    var var_updatedAt = sse_decode_u_64(deserializer);
    ...
    return ApiMultisigSigningRequest(
      ...
      round1ParticipantIds: var_round1ParticipantIds,
      round2ParticipantIds: var_round2ParticipantIds,
      broadcastParticipantIds: var_broadcastParticipantIds,
      state: var_state,
      createdAt: var_createdAt,
      updatedAt: var_updatedAt,
  ...
  List<ApiMultisigParticipant> sse_decode_list_api_multisig_participant(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <ApiMultisigParticipant>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_api_multisig_participant(deserializer));
    }
    return ans_;
  }

  @protected
  List<ApiMultisigSessionEvent> sse_decode_list_api_multisig_session_event(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs

    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <ApiMultisigSessionEvent>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_api_multisig_session_event(deserializer));
    }
    return ans_;
  }
  ...
  List<ApiMultisigSigningMessage> sse_decode_list_api_multisig_signing_message(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <ApiMultisigSigningMessage>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_api_multisig_signing_message(deserializer));
    }
    return ans_;
  }
  ...
  void sse_encode_api_multisig_auth_session(
    ...
    sse_encode_String(self.admissionSecretKey, serializer);
    sse_encode_String(self.admissionPublicKey, serializer);
    sse_encode_String(self.deliverySecretKey, serializer);
    sse_encode_String(self.deliveryPublicKey, serializer);
    sse_encode_u_64(self.accessTokenExpiresAt, serializer);
    sse_encode_u_64(self.refreshTokenExpiresAt, serializer);
    sse_encode_String(self.state, serializer);
    sse_encode_api_multisig_participant(self.participant, serializer);
  }
  ...
  void sse_encode_api_multisig_backup_artifact(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_String(self.artifactJson, serializer);
    sse_encode_String(self.backupHash, serializer);
  ...
  void sse_encode_api_multisig_backup_verification(
    ...
    sse_encode_u_16(self.participantCount, serializer);
    sse_encode_String(self.rosterHash, serializer);
    sse_encode_String(self.admissionSecretKey, serializer);
    sse_encode_String(self.admissionPublicKey, serializer);
    sse_encode_String(self.deliverySecretKey, serializer);
    sse_encode_String(self.deliveryPublicKey, serializer);
    sse_encode_String(self.keyPackageB64, serializer);
    sse_encode_String(self.groupPublicPackageJson, serializer);
    sse_encode_String(self.groupPublicPackageHash, serializer);
  }
  ...
  void sse_encode_api_multisig_create_advance(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_api_multisig_session(self.session, serializer);
    sse_encode_String(self.localStateJson, serializer);
    sse_encode_String(self.phase, serializer);
    sse_encode_String(self.detail, serializer);
    sse_encode_list_String(self.waitingForParticipantIds, serializer);
    sse_encode_u_32(self.round1Count, serializer);
    sse_encode_u_32(self.round2Count, serializer);
    sse_encode_bool(self.dkgCompleteSubmitted, serializer);
    sse_encode_opt_String(self.keyPackageB64, serializer);
    sse_encode_opt_String(self.groupPublicPackageJson, serializer);
    sse_encode_opt_String(self.groupPublicPackageHash, serializer);
  }

  @protected
  void sse_encode_api_multisig_outbox_dispatch(
    ApiMultisigOutboxDispatch self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_String(self.localStateJson, serializer);
  ...
  void sse_encode_api_multisig_participant(
    ...
    sse_encode_bool(self.dkgCompleted, serializer);
  }
  ...
  void sse_encode_api_multisig_session(
    ...
    sse_encode_opt_String(self.groupPublicPackageHash, serializer);
    sse_encode_list_api_multisig_participant(self.participants, serializer);
    sse_encode_u_64(self.createdAt, serializer);
    sse_encode_u_64(self.updatedAt, serializer);
  }

  @protected
  void sse_encode_api_multisig_session_event(
    ApiMultisigSessionEvent self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    ...
    sse_encode_opt_String(self.actorParticipantId, serializer);
    sse_encode_String(self.payloadJson, serializer);
    sse_encode_u_64(self.createdAt, serializer);
  }

  @protected
  void sse_encode_api_multisig_session_events(
    ApiMultisigSessionEvents self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_i_64(self.cursor, serializer);
    sse_encode_list_api_multisig_session_event(self.events, serializer);
  }
  ...
  void sse_encode_api_multisig_signing_inbox(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_i_64(self.cursor, serializer);
    sse_encode_list_api_multisig_signing_message(self.messages, serializer);
  }
  ...
  void sse_encode_api_multisig_signing_request(
    ...
    sse_encode_list_String(self.round1ParticipantIds, serializer);
    sse_encode_list_String(self.round2ParticipantIds, serializer);
    sse_encode_list_String(self.broadcastParticipantIds, serializer);
    sse_encode_String(self.state, serializer);
    sse_encode_u_64(self.createdAt, serializer);
    sse_encode_u_64(self.updatedAt, serializer);
  ...
  void sse_encode_list_api_multisig_participant(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_api_multisig_participant(item, serializer);
    }
  }

  @protected
  void sse_encode_list_api_multisig_session_event(
    List<ApiMultisigSessionEvent> self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_api_multisig_session_event(item, serializer);
    }
  }
  ...
  void sse_encode_list_api_multisig_signing_message(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_api_multisig_signing_message(item, serializer);
    }
  }
