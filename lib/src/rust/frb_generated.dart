...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 1452638770;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<List<ReceivedMemo>> crateApiSyncGetReceivedMemos({
    required String dbPath,
    required String network,
    required String accountUuid,
    String? query,
  ...
  Future<List<AccountAddress>> crateApiWalletListAccountAddresses({
    required String dbPath,
    required String network,
    required String accountUuid,
  });
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<List<ReceivedMemo>> crateApiSyncGetReceivedMemos({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_list_received_memo,
          decodeErrorData: sse_decode_String,
        ),
        constMeta: kCrateApiSyncGetReceivedMemosConstMeta,
        argValues: [dbPath, network, accountUuid, query],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiSyncGetReceivedMemosConstMeta =>
      const TaskConstMeta(
        debugName: "get_received_memos",
        argNames: ["dbPath", "network", "accountUuid", "query"],
      );
  ...
  Future<List<AccountAddress>> crateApiWalletListAccountAddresses({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_list_account_address,
          decodeErrorData: sse_decode_String,
        ),
        constMeta: kCrateApiWalletListAccountAddressesConstMeta,
        argValues: [dbPath, network, accountUuid],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiWalletListAccountAddressesConstMeta =>
      const TaskConstMeta(
        debugName: "list_account_addresses",
        argNames: ["dbPath", "network", "accountUuid"],
      );
  ...
  List<AccountAddress> dco_decode_list_account_address(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_account_address).toList();
  }
  ...
  List<ReceivedMemo> dco_decode_list_received_memo(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_received_memo).toList();
  }
  ...
  ReceivedMemo dco_decode_received_memo(dynamic raw) {
    ...
    return ReceivedMemo(
      ...
      blockTime: dco_decode_u_64(arr[3]),
      minedHeight: dco_decode_u_64(arr[4]),
  ...
  TransactionDetail dco_decode_transaction_detail(dynamic raw) {
    ...
    return TransactionDetail(
      ...
      memoOutputKey: dco_decode_opt_String(arr[4]),
      outputs: dco_decode_list_transaction_detail_output(arr[5]),
    );
  }
  ...
  AccountAddress sse_decode_account_address(SseDeserializer deserializer) {
    ...
    return AccountAddress(address: var_address, isDefault: var_isDefault);
  }
  ...
  List<AccountAddress> sse_decode_list_account_address(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <AccountAddress>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_account_address(deserializer));
    }
    return ans_;
  }
  ...
  List<ReceivedMemo> sse_decode_list_received_memo(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <ReceivedMemo>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_received_memo(deserializer));
    }
    return ans_;
  }
  ...
  TransactionDetail sse_decode_transaction_detail(
    ...
    var var_memoOutputKey = sse_decode_opt_String(deserializer);
    ...
    return TransactionDetail(
      ...
      memo: var_memo,
      memoOutputKey: var_memoOutputKey,
      outputs: var_outputs,
    );
  }
  ...
  void sse_encode_list_account_address(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_account_address(item, serializer);
    }
  }
  ...
  void sse_encode_list_received_memo(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_received_memo(item, serializer);
    }
  }
  ...
  void sse_encode_transaction_detail(
    ...
    sse_encode_opt_String(self.memoOutputKey, serializer);
