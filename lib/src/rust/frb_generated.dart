...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -104911089;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<String> crateApiWalletOrchardOnlyUnifiedAddress({
    required String address,
    required String network,
  });
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<String> crateApiWalletOrchardOnlyUnifiedAddress({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiWalletOrchardOnlyUnifiedAddressConstMeta,
  ...
  TaskConstMeta get kCrateApiWalletOrchardOnlyUnifiedAddressConstMeta =>
      const TaskConstMeta(
        debugName: "orchard_only_unified_address",
