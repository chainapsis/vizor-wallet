...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -675091227;
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<VotingConfigResolution> crateApiVotingConfigResolveVotingConfig({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiVotingConfigResolveVotingConfigConstMeta,
        argValues: [source, previous, fetchBytes],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiVotingConfigResolveVotingConfigConstMeta =>
      const TaskConstMeta(
        debugName: "resolve_voting_config",
        argNames: ["source", "previous", "fetchBytes"],
      );
  ...
  ResolvedVotingConfig dco_decode_resolved_voting_config(dynamic raw) {
    ...
    return ResolvedVotingConfig(
      ...
      authenticatedRoundIds: dco_decode_list_String(arr[6]),
  ...
  ResolvedVotingConfig sse_decode_resolved_voting_config(
    ...
    var var_authenticatedRoundIds = sse_decode_list_String(deserializer);
    ...
    return ResolvedVotingConfig(
      ...
      authenticatedRoundIds: var_authenticatedRoundIds,
  ...
  void sse_encode_resolved_voting_config(
    ...
    sse_encode_list_String(self.authenticatedRoundIds, serializer);
