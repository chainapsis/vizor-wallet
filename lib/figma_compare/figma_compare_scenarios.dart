...
const figmaCompareScenarios = <FigmaCompareScenario>[
  ...
  FigmaCompareScenario(
    id: 'swap-deposit-network-row',
    description: 'Desktop deposit page with the Network detail row',
    builder: buildSwapDepositNetworkRowUseCase,
  ),
  FigmaCompareScenario(
    id: 'swap-deposit-timeout-recovery',
    description: 'Desktop deposit timeout with the late-deposit prompt',
    builder: buildSwapDepositTimeoutRecoveryUseCase,
  ),
  FigmaCompareScenario(
    id: 'swap-late-deposit-modal',
    description: 'Desktop late-deposit explainer modal',
    builder: buildSwapLateDepositModalUseCase,
  ),
  FigmaCompareScenario(
    id: 'mobile-swap-deposit-network-row',
    description: 'Mobile deposit page with the Network detail row',
    builder: buildMobileSwapDepositNetworkRowUseCase,
    desktop: false,
    mobile: true,
  ),
  FigmaCompareScenario(
    id: 'mobile-swap-deposit-network-sheet',
    description: 'Mobile bottom sheet behind the deposit Network row help',
    builder: buildMobileSwapDepositNetworkSheetUseCase,
    desktop: false,
    mobile: true,
  ),
  FigmaCompareScenario(
