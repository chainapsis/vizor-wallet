...
const figmaCompareScenarios = <FigmaCompareScenario>[
  ...
  FigmaCompareScenario(
    id: 'accounts-ledger',
    description: 'Desktop independent Ledger accounts',
    builder: buildAccountsLedgerUseCase,
  ),
  FigmaCompareScenario(
    id: 'mobile-accounts-ledger',
    description: 'Mobile independent Ledger accounts',
    builder: buildMobileAccountsLedgerUseCase,
    desktop: false,
    mobile: true,
  ),
  FigmaCompareScenario(
