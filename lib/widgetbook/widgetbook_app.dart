...
/// Existing registry retained until the feature galleries are connected.
          ...
          WidgetbookComponent(
            ...
            useCases: [
              ...
              WidgetbookUseCase(
                ...
                builder: buildMobileSecretPassphraseScreenshotWarningUseCase,
              ),
              WidgetbookUseCase(
                name: 'Import paste',
          ...
          WidgetbookComponent(
            ...
            useCases: [
              WidgetbookUseCase(
                ...
                builder: buildReceivedReceiptTransparentToTransparentUseCase,
              ),
              WidgetbookUseCase(
  ...
  WidgetbookFolder(
    ...
    children: [
      WidgetbookComponent(
        name: 'Typography',
        useCases: [
          WidgetbookUseCase(name: 'All', builder: buildTypographyAllUseCase),
        ],
      ),
      WidgetbookComponent(
        name: 'Spacing',
      ...
      WidgetbookComponent(
        name: 'Radii',
        useCases: [WidgetbookUseCase(name: 'All', builder: buildRadiiUseCase)],
      ),
    ],
  ),
  WidgetbookFolder(
    ...
    children: [
      ...
      WidgetbookComponent(
        name: 'Toast',
        useCases: [WidgetbookUseCase(name: 'All', builder: buildToastUseCase)],
      ),
      WidgetbookComponent(
    ...
    children: [
      WidgetbookComponent(
        ...
        useCases: [
          ...
          WidgetbookUseCase(name: 'Plum', builder: buildPrimitivesPlumUseCase),
          WidgetbookUseCase(name: 'Gold', builder: buildPrimitivesGoldUseCase),
          WidgetbookUseCase(
            name: 'Green',
      ...
      WidgetbookComponent(
        name: 'Border',
        useCases: [WidgetbookUseCase(name: 'All', builder: buildBorderUseCase)],
      ),
      WidgetbookComponent(
        name: 'Text',
        useCases: [WidgetbookUseCase(name: 'All', builder: buildTextUseCase)],
      ),
      WidgetbookComponent(
        name: 'Icon',
        useCases: [WidgetbookUseCase(name: 'All', builder: buildIconUseCase)],
      ),
      WidgetbookComponent(
        name: 'Button',
        useCases: [
      ...
      WidgetbookComponent(
        name: 'State',
        useCases: [WidgetbookUseCase(name: 'All', builder: buildStateUseCase)],
      ),
      WidgetbookComponent(
        name: 'Fade',
        useCases: [WidgetbookUseCase(name: 'All', builder: buildFadeUseCase)],
      ),
    ],
  ),
];
